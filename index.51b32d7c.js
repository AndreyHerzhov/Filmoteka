 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ce,Pe,Ne=function(){"use strict";function e(r){t(k)(this,e),this.name=r,this.providers=new Map}return t(_)(e,[{key:"addComponent",value:function(e){var t=this.getProvider(e.name);if(t.isComponentSet())throw new Error("Component ".concat(e.name," has already been registered with ").concat(this.name));t.setComponent(e)}},{key:"addOrOverwriteComponent",value:function(e){this.getProvider(e.name).isComponentSet()&&this.providers.delete(e.name),this.addComponent(e)}},{key:"getProvider",value:function(e){if(this.providers.has(e))return this.providers.get(e);var t=new Le(e,this);return this.providers.set(e,t),t}},{key:"getProviders",value:function(){return Array.from(this.providers.values())}}]),e}(),Me=(k=a("8MBJY"),_=a("a2hTj"),H=a("hKHmD"),[]);(Pe=Ce||(Ce={}))[Pe.DEBUG=0]="DEBUG",Pe[Pe.VERBOSE=1]="VERBOSE",Pe[Pe.INFO=2]="INFO",Pe[Pe.WARN=3]="WARN",Pe[Pe.ERROR=4]="ERROR",Pe[Pe.SILENT=5]="SILENT";var De,Be={debug:Ce.DEBUG,verbose:Ce.VERBOSE,info:Ce.INFO,warn:Ce.WARN,error:Ce.ERROR,silent:Ce.SILENT},Ue=Ce.INFO,je=(De={},t(H)(De,Ce.DEBUG,"log"),t(H)(De,Ce.VERBOSE,"log"),t(H)(De,Ce.INFO,"info"),t(H)(De,Ce.WARN,"warn"),t(H)(De,Ce.ERROR,"error"),De),Fe=function(e,r){for(var n=arguments.length,i=new Array(n>2?n-2:0),a=2;a<n;a++)i[a-2]=arguments[a];var o;if(!(r<e.logLevel)){var s=(new Date).toISOString(),u=je[r];if(!u)throw new Error("Attempted to log a message with an invalid logType (value: ".concat(r,")"));(o=console)[u].apply(o,["[".concat(s,"]  ").concat(e.name,":")].concat(t(q)(i)))}},He=function(){"use strict";function e(r){t(k)(this,e),this.name=r,this._logLevel=Ue,this._logHandler=Fe,this._userLogHandler=null,Me.push(this)}return t(_)(e,[{key:"logLevel",get:function(){return this._logLevel},set:function(e){if(!(e in Ce))throw new TypeError('Invalid value "'.concat(e,'" assigned to `logLevel`'));this._logLevel=e}},{key:"setLogLevel",value:function(e){this._logLevel="string"==typeof e?Be[e]:e}},{key:"logHandler",get:function(){return this._logHandler},set:function(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}},{key:"userLogHandler",get:function(){return this._userLogHandler},set:function(e){this._userLogHandler=e}},{key:"debug",value:function(){for(var e=arguments.length,r=new Array(e),n=0;n<e;n++)r[n]=arguments[n];this._userLogHandler&&this._userLogHandler.apply(this,[this,Ce.DEBUG].concat(t(q)(r))),this._logHandler.apply(this,[this,Ce.DEBUG].concat(t(q)(r)))}},{key:"log",value:function(){for(var e=arguments.length,r=new Array(e),n=0;n<e;n++)r[n]=arguments[n];this._userLogHandler&&this._userLogHandler.apply(this,[this,Ce.VERBOSE].concat(t(q)(r))),this._logHandler.apply(this,[this,Ce.VERBOSE].concat(t(q)(r)))}},{key:"info",value:function(){for(var e=arguments.length,r=new Array(e),n=0;n<e;n++)r[n]=arguments[n];this._userLogHandler&&this._userLogHandler.apply(this,[this,Ce.INFO].concat(t(q)(r))),this._logHandler.apply(this,[this,Ce.INFO].concat(t(q)(r)))}},{key:"warn",value:function(){for(var e=arguments.length,r=new Array(e),n=0;n<e;n++)r[n]=arguments[n];this._userLogHandler&&this._userLogHandler.apply(this,[this,Ce.WARN].concat(t(q)(r))),this._logHandler.apply(this,[this,Ce.WARN].concat(t(q)(r)))}},{key:"error",value:function(){for(var e=arguments.length,r=new Array(e),n=0;n<e;n++)r[n]=arguments[n];this._userLogHandler&&this._userLogHandler.apply(this,[this,Ce.ERROR].concat(t(q)(r))),this._logHandler.apply(this,[this,Ce.ERROR].concat(t(q)(r)))}}]),e}();var qe,Ve;var We=new WeakMap,ze=new WeakMap,Ge=new WeakMap,Je=new WeakMap,Ke=new WeakMap;var Ye={get:function(e,t,r){if(e instanceof IDBTransaction){if("done"===t)return ze.get(e);if("objectStoreNames"===t)return e.objectStoreNames||Ge.get(e);if("store"===t)return r.objectStoreNames[1]?void 0:r.objectStore(r.objectStoreNames[0])}return $e(e[t])},set:function(e,t,r){return e[t]=r,!0},has:function(e,t){return e instanceof IDBTransaction&&("done"===t||"store"===t)||t in e}};function Xe(e){return e!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?(Ve||(Ve=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])).includes(e)?function(){for(var t=arguments.length,r=new Array(t),n=0;n<t;n++)r[n]=arguments[n];return e.apply(Ze(this),r),$e(We.get(this))}:function(){for(var t=arguments.length,r=new Array(t),n=0;n<t;n++)r[n]=arguments[n];return $e(e.apply(Ze(this),r))}:function(r){for(var n=arguments.length,i=new Array(n>1?n-1:0),a=1;a<n;a++)i[a-1]=arguments[a];var o,s=(o=e).call.apply(o,[Ze(this),r].concat(t(q)(i)));return Ge.set(s,r.sort?r.sort():[r]),$e(s)}}function Qe(e){return"function"==typeof e?Xe(e):(e instanceof IDBTransaction&&function(e){if(!ze.has(e)){var t=new Promise((function(t,r){var n=function(){e.removeEventListener("complete",i),e.removeEventListener("error",a),e.removeEventListener("abort",a)},i=function(){t(),n()},a=function(){r(e.error||new DOMException("AbortError","AbortError")),n()};e.addEventListener("complete",i),e.addEventListener("error",a),e.addEventListener("abort",a)}));ze.set(e,t)}}(e),t=e,(qe||(qe=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])).some((function(e){return t instanceof e}))?new Proxy(e,Ye):e);var t}function $e(e){if(e instanceof IDBRequest)return t=e,(r=new Promise((function(e,r){var n=function(){t.removeEventListener("success",i),t.removeEventListener("error",a)},i=function(){e($e(t.result)),n()},a=function(){r(t.error),n()};t.addEventListener("success",i),t.addEventListener("error",a)}))).then((function(e){e instanceof IDBCursor&&We.set(e,t)})).catch((function(){})),Ke.set(r,t),r;var t,r;if(Je.has(e))return Je.get(e);var n=Qe(e);return n!==e&&(Je.set(e,n),Ke.set(n,e)),n}var Ze=function(e){return Ke.get(e)};function et(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},n=r.blocked,i=r.upgrade,a=r.blocking,o=r.terminated,s=indexedDB.open(e,t),u=$e(s);return i&&s.addEventListener("upgradeneeded",(function(e){i($e(s.result),e.oldVersion,e.newVersion,$e(s.transaction))})),n&&s.addEventListener("blocked",(function(){return n()})),u.then((function(e){o&&e.addEventListener("close",(function(){return o()})),a&&e.addEventListener("versionchange",(function(){return a()}))})).catch((function(){})),u}var tt=["get","getKey","getAll","getAllKeys","count"],rt=["put","add","delete","clear"],nt=new Map;function it(e,r){if(e instanceof IDBDatabase&&!(r in e)&&"string"==typeof r){if(nt.get(r))return nt.get(r);var n=r.replace(/FromIndex$/,""),i=r!==n,a=rt.includes(n);if(n in(i?IDBIndex:IDBObjectStore).prototype&&(a||tt.includes(n))){var o,s=(o=t(g)(t(b).mark((function e(r){var o,s,u,c,l,f,h=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:for(o=h.length,s=new Array(o>1?o-1:0),u=1;u<o;u++)s[u-1]=h[u];return l=this.transaction(r,a?"readwrite":"readonly"),f=l.store,i&&(f=f.index(s.shift())),e.next=7,Promise.all([(c=f)[n].apply(c,t(q)(s)),a&&l.done]);case 7:return e.abrupt("return",e.sent[0]);case 8:case"end":return e.stop()}}),e,this)}))),function(e){return o.apply(this,arguments)});return nt.set(r,s),s}}}Ye=function(e){return t(x)({},e,{get:function(t,r,n){return it(t,r)||e.get(t,r,n)},has:function(t,r){return!!it(t,r)||e.has(t,r)}})}(Ye);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var at=function(){"use strict";function e(r){t(k)(this,e),this.container=r}return t(_)(e,[{key:"getPlatformInfoString",value:function(){return this.container.getProviders().map((function(e){if(function(e){var t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){var t=e.getImmediate();return"".concat(t.library,"/").concat(t.version)}return null})).filter((function(e){return e})).join(" ")}}]),e}();var ot,st,ut="@firebase/app",ct="0.7.27",lt=new He("@firebase/app"),ft="[DEFAULT]",ht=(ot={},t(H)(ot,ut,"fire-core"),t(H)(ot,"@firebase/app-compat","fire-core-compat"),t(H)(ot,"@firebase/analytics","fire-analytics"),t(H)(ot,"@firebase/analytics-compat","fire-analytics-compat"),t(H)(ot,"@firebase/app-check","fire-app-check"),t(H)(ot,"@firebase/app-check-compat","fire-app-check-compat"),t(H)(ot,"@firebase/auth","fire-auth"),t(H)(ot,"@firebase/auth-compat","fire-auth-compat"),t(H)(ot,"@firebase/database","fire-rtdb"),t(H)(ot,"@firebase/database-compat","fire-rtdb-compat"),t(H)(ot,"@firebase/functions","fire-fn"),t(H)(ot,"@firebase/functions-compat","fire-fn-compat"),t(H)(ot,"@firebase/installations","fire-iid"),t(H)(ot,"@firebase/installations-compat","fire-iid-compat"),t(H)(ot,"@firebase/messaging","fire-fcm"),t(H)(ot,"@firebase/messaging-compat","fire-fcm-compat"),t(H)(ot,"@firebase/performance","fire-perf"),t(H)(ot,"@firebase/performance-compat","fire-perf-compat"),t(H)(ot,"@firebase/remote-config","fire-rc"),t(H)(ot,"@firebase/remote-config-compat","fire-rc-compat"),t(H)(ot,"@firebase/storage","fire-gcs"),t(H)(ot,"@firebase/storage-compat","fire-gcs-compat"),t(H)(ot,"@firebase/firestore","fire-fst"),t(H)(ot,"@firebase/firestore-compat","fire-fst-compat"),t(H)(ot,"fire-js","fire-js"),t(H)(ot,"firebase","fire-js-all"),ot),dt=new Map,pt=new Map;function vt(e,t){try{e.container.addComponent(t)}catch(r){lt.debug("Component ".concat(t.name," failed to register with FirebaseApp ").concat(e.name),r)}}function mt(e){var t=e.name;if(pt.has(t))return lt.debug("There were multiple attempts to register component ".concat(t,".")),!1;pt.set(t,e);var r=!0,n=!1,i=void 0;try{for(var a,o=dt.values()[Symbol.iterator]();!(r=(a=o.next()).done);r=!0){vt(a.value,e)}}catch(e){n=!0,i=e}finally{try{r||null==o.return||o.return()}finally{if(n)throw i}}return!0}function gt(e,t){var r=e.container.getProvider("heartbeat").getImmediate({optional:!0});return r&&r.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
xt("firebase","9.8.4","app");ee=a("ds8z5"),k=a("8MBJY"),_=a("a2hTj"),H=a("hKHmD");var Ut={};Object.defineProperty(Ut,"__esModule",{value:!0}),Ut.default=function(e,t,r){return Ft(e,t,r)};var jt=function(e){return e&&e.__esModule?e:{default:e}}(a("2mz0K"));function Ft(e,t,r){return(Ft="undefined"!=typeof Reflect&&Reflect.get?Reflect.get:function(e,t,r){var n=jt.default(e,t);if(n){var i=Object.getOwnPropertyDescriptor(n,t);return i.get?i.get.call(r||e):i.value}})(e,t,r)}var Ht=a("fVNic");te=a("eYQtU"),ce=a("2MbLg");function qt(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(n=Object.getOwnPropertySymbols(e);i<n.length;i++)t.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]])}return r}Object.create;Object.create;function Vt(){return t(H)({},"dependent-sdk-initialized-before-auth","Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK.")}var Wt=Vt,zt=new ge("auth","Firebase",Vt()),Gt=new He("@firebase/auth");function Jt(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];var a;Gt.logLevel<=Ce.ERROR&&(a=Gt).error.apply(a,["Auth (".concat(kt,"): ").concat(e)].concat(t(q)(n)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kt(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];throw Qt.apply(void 0,[e].concat(t(q)(n)))}function Yt(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];return Qt.apply(void 0,[e].concat(t(q)(n)))}function Xt(e,r,n){var i=Object.assign(Object.assign({},Wt()),t(H)({},r,n));return new ge("auth","Firebase",i).create(r,{appName:e.name})}function Qt(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];var a;if("string"!=typeof e){var o,s=n[0],u=t(q)(n.slice(1));return u[0]&&(u[0].appName=e.name),(o=e._errorFactory).create.apply(o,[s].concat(t(q)(u)))}return(a=zt).create.apply(a,[e].concat(t(q)(n)))}function $t(e,r){for(var n=arguments.length,i=new Array(n>2?n-2:0),a=2;a<n;a++)i[a-2]=arguments[a];if(!e)throw Qt.apply(void 0,[r].concat(t(q)(i)))}function Zt(e){var t="INTERNAL ASSERTION FAILED: "+e;throw Jt(t),new Error(t)}function er(e,t){e||Zt(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function qi(e,t){return t?rr(t):($t(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Hi.PROVIDER_ID="phone",Hi.PHONE_SIGN_IN_METHOD="phone";var Vi=function(e){"use strict";t(te)(n,e);var r=t(ce)(n);function n(e){var i;return t(k)(this,n),(i=r.call(this,"custom","custom")).params=e,i}return t(_)(n,[{key:"_getIdTokenResponse",value:function(e){return In(e,this._buildIdpRequest())}},{key:"_linkToIdToken",value:function(e,t){return In(e,this._buildIdpRequest(t))}},{key:"_getReauthenticationResolver",value:function(e){return In(e,this._buildIdpRequest())}},{key:"_buildIdpRequest",value:function(e){var t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}]),n}(vn);function Wi(e){return Zn(e.auth,new Vi(e),e.bypassAuthState)}function zi(e){var t=e.auth,r=e.user;return $t(r,t,"internal-error"),Qn(r,new Vi(e),e.bypassAuthState)}function Gi(e){return Ji.apply(this,arguments)}function Ji(){return(Ji=t(g)(t(b).mark((function e(r){var n,i;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.auth,$t(i=r.user,n,"internal-error"),e.abrupt("return",Yn(i,new Vi(r),r.bypassAuthState));case 3:case"end":return e.stop()}}),e)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var va=new ur(3e4,6e4);function ma(){var e=gi().___jsl,r=!0,n=!1,i=void 0;if(null==e?void 0:e.H)try{for(var a,o=Object.keys(e.H)[Symbol.iterator]();!(r=(a=o.next()).done);r=!0){var s=a.value;if(e.H[s].r=e.H[s].r||[],e.H[s].L=e.H[s].L||[],e.H[s].r=t(q)(e.H[s].L),e.CP)for(var u=0;u<e.CP.length;u++)e.CP[u]=null}}catch(e){n=!0,i=e}finally{try{r||null==o.return||o.return()}finally{if(n)throw i}}}var ga=null;function ya(e){return ga=ga||function(e){return new Promise((function(t,r){var n,i,a;function o(){ma(),gapi.load("gapi.iframes",{callback:function(){t(gapi.iframes.getContext())},ontimeout:function(){ma(),r(Yt(e,"network-request-failed"))},timeout:va.get()})}if(null===(i=null===(n=gi().gapi)||void 0===n?void 0:n.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(a=gi().gapi)||void 0===a?void 0:a.load)){var s=Bi("iframefcb");return gi()[s]=function(){gapi.load?o():r(Yt(e,"network-request-failed"))},Di("https://apis.google.com/js/api.js?onload=".concat(s)).catch((function(e){return r(e)}))}o()}})).catch((function(e){throw ga=null,e}))}(e),ga}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
