 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gt(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];throw Xt.apply(void 0,[e].concat(t(q)(n)))}function Kt(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];return Xt.apply(void 0,[e].concat(t(q)(n)))}function Yt(e,r,n){var i=Object.assign(Object.assign({},Vt()),t(F)({},r,n));return new ge("auth","Firebase",i).create(r,{appName:e.name})}function Xt(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];var a;if("string"!=typeof e){var o,s=n[0],u=t(q)(n.slice(1));return u[0]&&(u[0].appName=e.name),(o=e._errorFactory).create.apply(o,[s].concat(t(q)(u)))}return(a=Wt).create.apply(a,[e].concat(t(q)(n)))}function Qt(e,r){for(var n=arguments.length,i=new Array(n>2?n-2:0),a=2;a<n;a++)i[a-2]=arguments[a];if(!e)throw Xt.apply(void 0,[r].concat(t(q)(i)))}function $t(e){var t="INTERNAL ASSERTION FAILED: "+e;throw Jt(t),new Error(t)}function Zt(e,t){e||$t(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function qi(e,t){return t?tr(t):(Qt(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Fi.PROVIDER_ID="phone",Fi.PHONE_SIGN_IN_METHOD="phone";var Hi=function(e){"use strict";t(ee)(n,e);var r=t(ue)(n);function n(e){var i;return t(k)(this,n),(i=r.call(this,"custom","custom")).params=e,i}return t(_)(n,[{key:"_getIdTokenResponse",value:function(e){return En(e,this._buildIdpRequest())}},{key:"_linkToIdToken",value:function(e,t){return En(e,this._buildIdpRequest(t))}},{key:"_getReauthenticationResolver",value:function(e){return En(e,this._buildIdpRequest())}},{key:"_buildIdpRequest",value:function(e){var t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}]),n}(pn);function Vi(e){return $n(e.auth,new Hi(e),e.bypassAuthState)}function Wi(e){var t=e.auth,r=e.user;return Qt(r,t,"internal-error"),Xn(r,new Hi(e),e.bypassAuthState)}function zi(e){return Ji.apply(this,arguments)}function Ji(){return(Ji=t(m)(t(b).mark((function e(r){var n,i;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.auth,Qt(i=r.user,n,"internal-error"),e.abrupt("return",Kn(i,new Hi(r),r.bypassAuthState));case 3:case"end":return e.stop()}}),e)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ha(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:kt(),t=gt(e,"auth");return t.isInitialized()?t.getImmediate():rr(e,{popupRedirectResolver:Ma,persistence:[Pi,ci,fi]})}Ua="Browser",vt(new Oe("auth",(function(e,t){var r=t.options,n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),a=n.options,o=a.apiKey,s=a.authDomain;return function(e,t){Qt(o&&!o.includes(":"),"invalid-api-key",{appName:e.name}),Qt(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});var n={apiKey:o,authDomain:s,clientPlatform:Ua,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:cn(Ua)},i=new fn(e,t,n);return function(e,t){var r=(null==t?void 0:t.persistence)||[],n=(Array.isArray(r)?r:[r]).map(tr);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(n,null==t?void 0:t.popupRedirectResolver)}(i,r),i}(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((function(e,t,r){e.getProvider("auth-internal").initialize()}))),vt(new Oe("auth-internal",(function(e){var t=hn(e.getProvider("auth").getImmediate());return new qa(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),_t(ja,Fa,
/**
 * @license
 * Copyright 2020 Google LLC
 *
