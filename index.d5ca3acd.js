 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function It(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Ot(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Tt(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(At(t))return"Blackberry";if(Ct(t))return"Webos";if(St(t))return"Safari";if((t.includes("chrome/")||kt(t))&&!t.includes("edge/"))return"Chrome";if(Rt(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=e.match(t);if(2===(null==r?void 0:r.length))return r[1]}return"Other"}function Tt(e=_()){return/firefox\//i.test(e)}function St(e=_()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function kt(e=_()){return/crios\//i.test(e)}function Ot(e=_()){return/iemobile/i.test(e)}function Rt(e=_()){return/android/i.test(e)}function At(e=_()){return/blackberry/i.test(e)}function Ct(e=_()){return/webos/i.test(e)}function Lt(e=_()){return/iphone|ipad|ipod/i.test(e)}function Nt(){return I()&&10===document.documentMode}function Pt(e=_()){return Lt(e)||Rt(e)||Ct(e)||At(e)||/windows phone/i.test(e)||Ot(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt{static parseLink(e){const t=function(e){const t=L(N(e)).link,r=t?L(N(t)).deep_link_id:null,n=L(N(e)).deep_link_id;return(n?L(N(n)).link:null)||n||r||t||e}(e);try{return new Wt(t)}catch(e){return null}}constructor(e){var t,r,n,i,s,o;const a=L(N(e)),c=null!==(t=a.apiKey)&&void 0!==t?t:null,u=null!==(r=a.oobCode)&&void 0!==r?r:null,l=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(n=a.mode)&&void 0!==n?n:null);Ve(c&&u&&l,"argument-error"),this.apiKey=c,this.operation=l,this.code=u,this.continueUrl=null!==(i=a.continueUrl)&&void 0!==i?i:null,this.languageCode=null!==(s=a.languageCode)&&void 0!==s?s:null,this.tenantId=null!==(o=a.tenantId)&&void 0!==o?o:null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Lr.PROVIDER_ID="phone",Lr.PHONE_SIGN_IN_METHOD="phone";class Pr extends jt{_getIdTokenResponse(e){return Vt(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Vt(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Vt(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function Dr(e){return ar(e.auth,new Pr(e),e.bypassAuthState)}function Ur(e){const{auth:t,user:r}=e;return Ve(r,t,"internal-error"),or(r,new Pr(e),e.bypassAuthState)}async function Br(e){const{auth:t,user:r}=e;return Ve(r,t,"internal-error"),sr(r,new Pr(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
//# sourceMappingURL=index.d5ca3acd.js.map
