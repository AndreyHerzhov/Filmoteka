 ...
 * limitations under the License.
 */
var yt="firebase-heartbeat-store",bt=null;function wt(){return bt||(bt=Ke("firebase-heartbeat-database",1,{upgrade:function(e,t){if(0===t)e.createObjectStore(yt)}}).catch((function(e){throw dt.create("storage-open",{originalErrorMessage:e.message})}))),bt}function kt(e){return _t.apply(this,arguments)}function _t(){return(_t=e(g)(e(b).mark((function t(r){var n,i;return e(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=1,e.next=4,wt();case 4:return i=e.sent,e.abrupt("return",i.transaction(yt).objectStore(yt).get(It(r)));case 8:throw e.prev=8,e.t0=e.catch(1),dt.create("storage-get",{originalErrorMessage:null===(n=e.t0)||void 0===n?void 0:n.message});case 11:case"end":return e.stop()}}),t,null,[[1,8]])})))).apply(this,arguments)}function xt(e,t){return Et.apply(this,arguments)}function Et(){return(Et=e(g)(e(b).mark((function t(r,n){var i,a,o,s;return e(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=1,e.next=4,wt();case 4:return a=e.sent,o=a.transaction(yt,"readwrite"),s=o.objectStore(yt),e.next=9,s.put(n,It(r));case 9:return e.abrupt("return",o.done);case 12:throw e.prev=12,e.t0=e.catch(1),dt.create("storage-set",{originalErrorMessage:null===(i=e.t0)||void 0===i?void 0:i.message});case 15:case"end":return e.stop()}}),t,null,[[1,12]])})))).apply(this,arguments)}function It(e){return"".concat(e.name,"!").concat(e.options.appId)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xr(){return xr=e(g)(e(b).mark((function t(r){var n,i,a,o,s,u,c=arguments;return e(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=c.length>1&&void 0!==c[1]&&c[1],i=_e(r),e.next=4,i.getIdToken(n);case 4:return a=e.sent,Gt((o=Ir(a))&&o.exp&&o.auth_time&&o.iat,i.auth,"internal-error"),s="object"==typeof o.firebase?o.firebase:void 0,u=null==s?void 0:s.sign_in_provider,e.abrupt("return",{claims:o,token:a,authTime:_r(Er(o.auth_time)),issuedAtTime:_r(Er(o.iat)),expirationTime:_r(Er(o.exp)),signInProvider:u||null,signInSecondFactor:(null==s?void 0:s.sign_in_second_factor)||null});case 10:case"end":return e.stop()}}),t)}))),xr.apply(this,arguments)}function Er(e){return 1e3*Number(e)}function Ir(t){var r,n=e(V)(t.split("."),3),i=n[0],a=n[1],o=n[2];if(void 0===i||void 0===a||void 0===o)return qt("JWT malformed, contained fewer than 3 sections"),null;try{var s=se(a);return s?JSON.parse(s):(qt("Failed to decode base64 JWT payload"),null)}catch(e){return qt("Caught error parsing JWT payload as JSON",null===(r=e)||void 0===r?void 0:r.toString()),null}}function Tr(e,t){return Sr.apply(this,arguments)}function Sr(){return Sr=
/**
 * @license
 * Copyright 2020 Google LLC
 *
