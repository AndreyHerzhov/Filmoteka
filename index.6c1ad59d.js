 ...
 * limitations under the License.
 */
var we=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(e,i,a){var o;return t(k)(this,n),(o=r.call(this,i)).code=e,o.customData=a,o.name="FirebaseError",Object.setPrototypeOf(t(ie)(o),n.prototype),Error.captureStackTrace&&Error.captureStackTrace(t(ie)(o),ke.prototype.create),o}return n}(t(oe)(Error)),ke=function(){"use strict";function e(r,n,i){t(k)(this,e),this.service=r,this.serviceName=n,this.errors=i}return t(_)(e,[{key:"create",value:function(e){for(var t=arguments.length,r=new Array(t>1?t-1:0),n=1;n<t;n++)r[n-1]=arguments[n];var i=r[0]||{},a="".concat(this.service,"/").concat(e),o=this.errors[e],s=o?_e(o,i):"Error",u="".concat(this.serviceName,": ").concat(s," (").concat(a,")."),c=new we(a,u,i);return c}}]),e}();function _e(e,t){return e.replace(xe,(function(e,r){var n=t[r];return null!=n?String(n):"<".concat(r,"?>")}))}var xe=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ee(e){for(var t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}function Ie(e,t){if(e===t)return!0;var r=Object.keys(e),n=Object.keys(t),i=!0,a=!1,o=void 0;try{for(var s,u=r[Symbol.iterator]();!(i=(s=u.next()).done);i=!0){var c=s.value;if(!n.includes(c))return!1;var l=e[c],f=t[c];if(Te(l)&&Te(f)){if(!Ie(l,f))return!1}else if(l!==f)return!1}}catch(e){a=!0,o=e}finally{try{i||null==u.return||u.return()}finally{if(a)throw o}}var h=!0,d=!1,p=void 0;try{for(var v,m=n[Symbol.iterator]();!(h=(v=m.next()).done);h=!0){var g=v.value;if(!r.includes(g))return!1}}catch(e){d=!0,p=e}finally{try{h||null==m.return||m.return()}finally{if(d)throw p}}return!0}function Te(e){return null!==e&&"object"==typeof e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Se(e){var r=[],n=!0,i=!1,a=void 0;try{for(var o,s=function(e,n){var i=t($)(n.value,2),a=i[0],o=i[1];Array.isArray(o)?o.forEach((function(e){r.push(encodeURIComponent(a)+"="+encodeURIComponent(e))})):r.push(encodeURIComponent(a)+"="+encodeURIComponent(o))},u=Object.entries(e)[Symbol.iterator]();!(n=(o=u.next()).done);n=!0)s(0,o)}catch(e){i=!0,a=e}finally{try{n||null==u.return||u.return()}finally{if(i)throw a}}return r.length?"&"+r.join("&"):""}function Oe(e){var r={};return e.replace(/^\?/,"").split("&").forEach((function(e){if(e){var n=t($)(e.split("="),2),i=n[0],a=n[1];r[decodeURIComponent(i)]=decodeURIComponent(a)}})),r}function Re(e){var t=e.indexOf("?");if(!t)return"";var r=e.indexOf("#",t);return e.substring(t,r>0?r:void 0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var De,Be,Ue=function(){"use strict";function e(r){t(k)(this,e),this.name=r,this.providers=new Map}return t(_)(e,[{key:"addComponent",value:function(e){var t=this.getProvider(e.name);if(t.isComponentSet())throw new Error("Component ".concat(e.name," has already been registered with ").concat(this.name));t.setComponent(e)}},{key:"addOrOverwriteComponent",value:function(e){this.getProvider(e.name).isComponentSet()&&this.providers.delete(e.name),this.addComponent(e)}},{key:"getProvider",value:function(e){if(this.providers.has(e))return this.providers.get(e);var t=new Me(e,this);return this.providers.set(e,t),t}},{key:"getProviders",value:function(){return Array.from(this.providers.values())}}]),e}(),je=(k=a("8MBJY"),_=a("a2hTj"),z=a("hKHmD"),[]);(Be=De||(De={}))[Be.DEBUG=0]="DEBUG",Be[Be.VERBOSE=1]="VERBOSE",Be[Be.INFO=2]="INFO",Be[Be.WARN=3]="WARN",Be[Be.ERROR=4]="ERROR",Be[Be.SILENT=5]="SILENT";var Fe,qe={debug:De.DEBUG,verbose:De.VERBOSE,info:De.INFO,warn:De.WARN,error:De.ERROR,silent:De.SILENT},He=De.INFO,Ve=(Fe={},t(z)(Fe,De.DEBUG,"log"),t(z)(Fe,De.VERBOSE,"log"),t(z)(Fe,De.INFO,"info"),t(z)(Fe,De.WARN,"warn"),t(z)(Fe,De.ERROR,"error"),Fe),We=function(e,r){for(var n=arguments.length,i=new Array(n>2?n-2:0),a=2;a<n;a++)i[a-2]=arguments[a];var o;if(!(r<e.logLevel)){var s=(new Date).toISOString(),u=Ve[r];if(!u)throw new Error("Attempted to log a message with an invalid logType (value: ".concat(r,")"));(o=console)[u].apply(o,["[".concat(s,"]  ").concat(e.name,":")].concat(t(J)(i)))}},ze=function(){"use strict";function e(r){t(k)(this,e),this.name=r,this._logLevel=He,this._logHandler=We,this._userLogHandler=null,je.push(this)}return t(_)(e,[{key:"logLevel",get:function(){return this._logLevel},set:function(e){if(!(e in De))throw new TypeError('Invalid value "'.concat(e,'" assigned to `logLevel`'));this._logLevel=e}},{key:"setLogLevel",value:function(e){this._logLevel="string"==typeof e?qe[e]:e}},{key:"logHandler",get:function(){return this._logHandler},set:function(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}},{key:"userLogHandler",get:function(){return this._userLogHandler},set:function(e){this._userLogHandler=e}},{key:"debug",value:function(){for(var e=arguments.length,r=new Array(e),n=0;n<e;n++)r[n]=arguments[n];this._userLogHandler&&this._userLogHandler.apply(this,[this,De.DEBUG].concat(t(J)(r))),this._logHandler.apply(this,[this,De.DEBUG].concat(t(J)(r)))}},{key:"log",value:function(){for(var e=arguments.length,r=new Array(e),n=0;n<e;n++)r[n]=arguments[n];this._userLogHandler&&this._userLogHandler.apply(this,[this,De.VERBOSE].concat(t(J)(r))),this._logHandler.apply(this,[this,De.VERBOSE].concat(t(J)(r)))}},{key:"info",value:function(){for(var e=arguments.length,r=new Array(e),n=0;n<e;n++)r[n]=arguments[n];this._userLogHandler&&this._userLogHandler.apply(this,[this,De.INFO].concat(t(J)(r))),this._logHandler.apply(this,[this,De.INFO].concat(t(J)(r)))}},{key:"warn",value:function(){for(var e=arguments.length,r=new Array(e),n=0;n<e;n++)r[n]=arguments[n];this._userLogHandler&&this._userLogHandler.apply(this,[this,De.WARN].concat(t(J)(r))),this._logHandler.apply(this,[this,De.WARN].concat(t(J)(r)))}},{key:"error",value:function(){for(var e=arguments.length,r=new Array(e),n=0;n<e;n++)r[n]=arguments[n];this._userLogHandler&&this._userLogHandler.apply(this,[this,De.ERROR].concat(t(J)(r))),this._logHandler.apply(this,[this,De.ERROR].concat(t(J)(r)))}}]),e}();var Je,Ge;var Ke=new WeakMap,Ye=new WeakMap,Qe=new WeakMap,Xe=new WeakMap,$e=new WeakMap;var Ze={get:function(e,t,r){if(e instanceof IDBTransaction){if("done"===t)return Ye.get(e);if("objectStoreNames"===t)return e.objectStoreNames||Qe.get(e);if("store"===t)return r.objectStoreNames[1]?void 0:r.objectStore(r.objectStoreNames[0])}return rt(e[t])},set:function(e,t,r){return e[t]=r,!0},has:function(e,t){return e instanceof IDBTransaction&&("done"===t||"store"===t)||t in e}};function et(e){return e!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?(Ge||(Ge=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])).includes(e)?function(){for(var t=arguments.length,r=new Array(t),n=0;n<t;n++)r[n]=arguments[n];return e.apply(nt(this),r),rt(Ke.get(this))}:function(){for(var t=arguments.length,r=new Array(t),n=0;n<t;n++)r[n]=arguments[n];return rt(e.apply(nt(this),r))}:function(r){for(var n=arguments.length,i=new Array(n>1?n-1:0),a=1;a<n;a++)i[a-1]=arguments[a];var o,s=(o=e).call.apply(o,[nt(this),r].concat(t(J)(i)));return Qe.set(s,r.sort?r.sort():[r]),rt(s)}}function tt(e){return"function"==typeof e?et(e):(e instanceof IDBTransaction&&function(e){if(!Ye.has(e)){var t=new Promise((function(t,r){var n=function(){e.removeEventListener("complete",i),e.removeEventListener("error",a),e.removeEventListener("abort",a)},i=function(){t(),n()},a=function(){r(e.error||new DOMException("AbortError","AbortError")),n()};e.addEventListener("complete",i),e.addEventListener("error",a),e.addEventListener("abort",a)}));Ye.set(e,t)}}(e),t=e,(Je||(Je=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])).some((function(e){return t instanceof e}))?new Proxy(e,Ze):e);var t}function rt(e){if(e instanceof IDBRequest)return t=e,(r=new Promise((function(e,r){var n=function(){t.removeEventListener("success",i),t.removeEventListener("error",a)},i=function(){e(rt(t.result)),n()},a=function(){r(t.error),n()};t.addEventListener("success",i),t.addEventListener("error",a)}))).then((function(e){e instanceof IDBCursor&&Ke.set(e,t)})).catch((function(){})),$e.set(r,t),r;var t,r;if(Xe.has(e))return Xe.get(e);var n=tt(e);return n!==e&&(Xe.set(e,n),$e.set(n,e)),n}var nt=function(e){return $e.get(e)};function it(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},n=r.blocked,i=r.upgrade,a=r.blocking,o=r.terminated,s=indexedDB.open(e,t),u=rt(s);return i&&s.addEventListener("upgradeneeded",(function(e){i(rt(s.result),e.oldVersion,e.newVersion,rt(s.transaction))})),n&&s.addEventListener("blocked",(function(){return n()})),u.then((function(e){o&&e.addEventListener("close",(function(){return o()})),a&&e.addEventListener("versionchange",(function(){return a()}))})).catch((function(){})),u}var at=["get","getKey","getAll","getAllKeys","count"],ot=["put","add","delete","clear"],st=new Map;function ut(e,r){if(e instanceof IDBDatabase&&!(r in e)&&"string"==typeof r){if(st.get(r))return st.get(r);var n=r.replace(/FromIndex$/,""),i=r!==n,a=ot.includes(n);if(n in(i?IDBIndex:IDBObjectStore).prototype&&(a||at.includes(n))){var o,s=(o=t(g)(t(b).mark((function e(r){var o,s,u,c,l,f,h=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:for(o=h.length,s=new Array(o>1?o-1:0),u=1;u<o;u++)s[u-1]=h[u];return l=this.transaction(r,a?"readwrite":"readonly"),f=l.store,i&&(f=f.index(s.shift())),e.next=7,Promise.all([(c=f)[n].apply(c,t(J)(s)),a&&l.done]);case 7:return e.abrupt("return",e.sent[0]);case 8:case"end":return e.stop()}}),e,this)}))),function(e){return o.apply(this,arguments)});return st.set(r,s),s}}}Ze=function(e){return t(x)({},e,{get:function(t,r,n){return ut(t,r)||e.get(t,r,n)},has:function(t,r){return!!ut(t,r)||e.has(t,r)}})}(Ze);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var ct=function(){"use strict";function e(r){t(k)(this,e),this.container=r}return t(_)(e,[{key:"getPlatformInfoString",value:function(){return this.container.getProviders().map((function(e){if(function(e){var t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){var t=e.getImmediate();return"".concat(t.library,"/").concat(t.version)}return null})).filter((function(e){return e})).join(" ")}}]),e}();var lt,ft,ht="@firebase/app",dt="0.7.27",pt=new ze("@firebase/app"),vt="[DEFAULT]",mt=(lt={},t(z)(lt,ht,"fire-core"),t(z)(lt,"@firebase/app-compat","fire-core-compat"),t(z)(lt,"@firebase/analytics","fire-analytics"),t(z)(lt,"@firebase/analytics-compat","fire-analytics-compat"),t(z)(lt,"@firebase/app-check","fire-app-check"),t(z)(lt,"@firebase/app-check-compat","fire-app-check-compat"),t(z)(lt,"@firebase/auth","fire-auth"),t(z)(lt,"@firebase/auth-compat","fire-auth-compat"),t(z)(lt,"@firebase/database","fire-rtdb"),t(z)(lt,"@firebase/database-compat","fire-rtdb-compat"),t(z)(lt,"@firebase/functions","fire-fn"),t(z)(lt,"@firebase/functions-compat","fire-fn-compat"),t(z)(lt,"@firebase/installations","fire-iid"),t(z)(lt,"@firebase/installations-compat","fire-iid-compat"),t(z)(lt,"@firebase/messaging","fire-fcm"),t(z)(lt,"@firebase/messaging-compat","fire-fcm-compat"),t(z)(lt,"@firebase/performance","fire-perf"),t(z)(lt,"@firebase/performance-compat","fire-perf-compat"),t(z)(lt,"@firebase/remote-config","fire-rc"),t(z)(lt,"@firebase/remote-config-compat","fire-rc-compat"),t(z)(lt,"@firebase/storage","fire-gcs"),t(z)(lt,"@firebase/storage-compat","fire-gcs-compat"),t(z)(lt,"@firebase/firestore","fire-fst"),t(z)(lt,"@firebase/firestore-compat","fire-fst-compat"),t(z)(lt,"fire-js","fire-js"),t(z)(lt,"firebase","fire-js-all"),lt),gt=new Map,yt=new Map;function bt(e,t){try{e.container.addComponent(t)}catch(r){pt.debug("Component ".concat(t.name," failed to register with FirebaseApp ").concat(e.name),r)}}function wt(e){var t=e.name;if(yt.has(t))return pt.debug("There were multiple attempts to register component ".concat(t,".")),!1;yt.set(t,e);var r=!0,n=!1,i=void 0;try{for(var a,o=gt.values()[Symbol.iterator]();!(r=(a=o.next()).done);r=!0){bt(a.value,e)}}catch(e){n=!0,i=e}finally{try{r||null==o.return||o.return()}finally{if(n)throw i}}return!0}function kt(e,t){var r=e.container.getProvider("heartbeat").getImmediate({optional:!0});return r&&r.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var _t=(ft={},t(z)(ft,"no-app","No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()"),t(z)(ft,"bad-app-name","Illegal App name: '{$appName}"),t(z)(ft,"duplicate-app","Firebase App named '{$appName}' already exists with different options or config"),t(z)(ft,"app-deleted","Firebase App named '{$appName}' already deleted"),t(z)(ft,"invalid-app-argument","firebase.{$appName}() takes either no argument or a Firebase App instance."),t(z)(ft,"invalid-log-argument","First argument to `onLog` must be null or a function."),t(z)(ft,"storage-open","Error thrown when opening storage. Original error: {$originalErrorMessage}."),t(z)(ft,"storage-get","Error thrown when reading from storage. Original error: {$originalErrorMessage}."),t(z)(ft,"storage-set","Error thrown when writing to storage. Original error: {$originalErrorMessage}."),t(z)(ft,"storage-delete","Error thrown when deleting from storage. Original error: {$originalErrorMessage}."),ft),xt=new ke("app","Firebase",_t),Et=function(){"use strict";function e(r,n,i){var a=this;t(k)(this,e),this._isDeleted=!1,this._options=Object.assign({},r),this._config=Object.assign({},n),this._name=n.name,this._automaticDataCollectionEnabled=n.automaticDataCollectionEnabled,this._container=i,this.container.addComponent(new Pe("app",(function(){return a}),"PUBLIC"))}return t(_)(e,[{key:"automaticDataCollectionEnabled",get:function(){return this.checkDestroyed(),this._automaticDataCollectionEnabled},set:function(e){this.checkDestroyed(),this._automaticDataCollectionEnabled=e}},{key:"name",get:function(){return this.checkDestroyed(),this._name}},{key:"options",get:function(){return this.checkDestroyed(),this._options}},{key:"config",get:function(){return this.checkDestroyed(),this._config}},{key:"container",get:function(){return this._container}},{key:"isDeleted",get:function(){return this._isDeleted},set:function(e){this._isDeleted=e}},{key:"checkDestroyed",value:function(){if(this.isDeleted)throw xt.create("app-deleted",{appName:this._name})}}]),e}(),It="9.8.4";function Tt(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:vt,t=gt.get(e);if(!t)throw xt.create("no-app",{appName:e});return t}function St(e,t,r){var n,i=null!==(n=mt[e])&&void 0!==n?n:e;r&&(i+="-".concat(r));var a=i.match(/\s|\//),o=t.match(/\s|\//);if(a||o){var s=['Unable to register library "'.concat(i,'" with version "').concat(t,'":')];return a&&s.push('library name "'.concat(i,'" contains illegal characters (whitespace or "/")')),a&&o&&s.push("and"),o&&s.push('version name "'.concat(t,'" contains illegal characters (whitespace or "/")')),void pt.warn(s.join(" "))}wt(new Pe("".concat(i,"-version"),(function(){return{library:i,version:t}}),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
var Ot="firebase-heartbeat-store",Rt=null;function At(){return Rt||(Rt=it("firebase-heartbeat-database",1,{upgrade:function(e,t){if(0===t)e.createObjectStore(Ot)}}).catch((function(e){throw xt.create("storage-open",{originalErrorMessage:e.message})}))),Rt}function Lt(e){return Ct.apply(this,arguments)}function Ct(){return(Ct=t(g)(t(b).mark((function e(r){var n,i;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=1,e.next=4,At();case 4:return i=e.sent,e.abrupt("return",i.transaction(Ot).objectStore(Ot).get(Mt(r)));case 8:throw e.prev=8,e.t0=e.catch(1),xt.create("storage-get",{originalErrorMessage:null===(n=e.t0)||void 0===n?void 0:n.message});case 11:case"end":return e.stop()}}),e,null,[[1,8]])})))).apply(this,arguments)}function Pt(e,t){return Nt.apply(this,arguments)}function Nt(){return(Nt=t(g)(t(b).mark((function e(r,n){var i,a,o,s;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=1,e.next=4,At();case 4:return a=e.sent,o=a.transaction(Ot,"readwrite"),s=o.objectStore(Ot),e.next=9,s.put(n,Mt(r));case 9:return e.abrupt("return",o.done);case 12:throw e.prev=12,e.t0=e.catch(1),xt.create("storage-set",{originalErrorMessage:null===(i=e.t0)||void 0===i?void 0:i.message});case 15:case"end":return e.stop()}}),e,null,[[1,12]])})))).apply(this,arguments)}function Mt(e){return"".concat(e.name,"!").concat(e.options.appId)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Dt=function(){"use strict";function e(r){var n=this;t(k)(this,e),this.container=r,this._heartbeatsCache=null;var i=this.container.getProvider("app").getImmediate();this._storage=new Ft(i),this._heartbeatsCachePromise=this._storage.read().then((function(e){return n._heartbeatsCache=e,e}))}return t(_)(e,[{key:"triggerHeartbeat",value:function(){var e=this;return t(g)(t(b).mark((function r(){var n,i,a;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(n=e.container.getProvider("platform-logger").getImmediate(),i=n.getPlatformInfoString(),a=Bt(),null!==e._heartbeatsCache){t.next=7;break}return t.next=6,e._heartbeatsCachePromise;case 6:e._heartbeatsCache=t.sent;case 7:if(e._heartbeatsCache.lastSentHeartbeatDate!==a&&!e._heartbeatsCache.heartbeats.some((function(e){return e.date===a}))){t.next=11;break}return t.abrupt("return");case 11:e._heartbeatsCache.heartbeats.push({date:a,agent:i});case 12:return e._heartbeatsCache.heartbeats=e._heartbeatsCache.heartbeats.filter((function(e){var t=new Date(e.date).valueOf();return Date.now()-t<=2592e6})),t.abrupt("return",e._storage.overwrite(e._heartbeatsCache));case 14:case"end":return t.stop()}}),r)})))()}},{key:"getHeartbeatsHeader",value:function(){var e=this;return t(g)(t(b).mark((function r(){var n,i,a,o,s;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(null!==e._heartbeatsCache){t.next=3;break}return t.next=3,e._heartbeatsCachePromise;case 3:if(null!==e._heartbeatsCache&&0!==e._heartbeatsCache.heartbeats.length){t.next=5;break}return t.abrupt("return","");case 5:if(n=Bt(),i=Ut(e._heartbeatsCache.heartbeats),a=i.heartbeatsToSend,o=i.unsentEntries,s=me(JSON.stringify({version:2,heartbeats:a})),e._heartbeatsCache.lastSentHeartbeatDate=n,!(o.length>0)){t.next=15;break}return e._heartbeatsCache.heartbeats=o,t.next=13,e._storage.overwrite(e._heartbeatsCache);case 13:t.next=16;break;case 15:e._heartbeatsCache.heartbeats=[],e._storage.overwrite(e._heartbeatsCache);case 16:return t.abrupt("return",s);case 17:case"end":return t.stop()}}),r)})))()}}]),e}();function Bt(){return(new Date).toISOString().substring(0,10)}function Ut(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:1024,r=[],n=e.slice(),i=!0,a=!1,o=void 0;try{for(var s,u=function(e,i){var a=i.value,o=r.find((function(e){return e.agent===a.agent}));if(o){if(o.dates.push(a.date),qt(r)>t)return o.dates.pop(),"break"}else if(r.push({agent:a.agent,dates:[a.date]}),qt(r)>t)return r.pop(),"break";n=n.slice(1)},c=e[Symbol.iterator]();!(i=(s=c.next()).done);i=!0){var l=u(c,s);if("break"===l)break}}catch(e){a=!0,o=e}finally{try{i||null==c.return||c.return()}finally{if(a)throw o}}return{heartbeatsToSend:r,unsentEntries:n}}var jt,Ft=function(){"use strict";function e(r){t(k)(this,e),this.app=r,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}return t(_)(e,[{key:"runIndexedDBEnvironmentCheck",value:function(){return t(g)(t(b).mark((function e(){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if("object"==typeof indexedDB){e.next=4;break}return e.abrupt("return",!1);case 4:return e.abrupt("return",new Promise((function(e,t){try{var r=!0,n="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(n);i.onsuccess=function(){i.result.close(),r||self.indexedDB.deleteDatabase(n),e(!0)},i.onupgradeneeded=function(){r=!1},i.onerror=function(){var e;t((null===(e=i.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}})).then((function(){return!0})).catch((function(){return!1})));case 5:case"end":return e.stop()}}),e)})))()}},{key:"read",value:function(){var e=this;return t(g)(t(b).mark((function r(){var n;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,e._canUseIndexedDBPromise;case 2:if(t.sent){t.next=7;break}return t.abrupt("return",{heartbeats:[]});case 7:return t.next=9,Lt(e.app);case 9:return n=t.sent,t.abrupt("return",n||{heartbeats:[]});case 11:case"end":return t.stop()}}),r)})))()}},{key:"overwrite",value:function(e){var r=this;return t(g)(t(b).mark((function n(){var i,a;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=3,r._canUseIndexedDBPromise;case 3:if(t.sent){t.next=8;break}return t.abrupt("return");case 8:return t.next=10,r.read();case 10:return a=t.sent,t.abrupt("return",Pt(r.app,{lastSentHeartbeatDate:null!==(i=e.lastSentHeartbeatDate)&&void 0!==i?i:a.lastSentHeartbeatDate,heartbeats:e.heartbeats}));case 12:case"end":return t.stop()}}),n)})))()}},{key:"add",value:function(e){var r=this;return t(g)(t(b).mark((function n(){var i,a;return t(b).wrap((function(n){for(;;)switch(n.prev=n.next){case 0:return n.next=3,r._canUseIndexedDBPromise;case 3:if(n.sent){n.next=8;break}return n.abrupt("return");case 8:return n.next=10,r.read();case 10:return a=n.sent,n.abrupt("return",Pt(r.app,{lastSentHeartbeatDate:null!==(i=e.lastSentHeartbeatDate)&&void 0!==i?i:a.lastSentHeartbeatDate,heartbeats:t(J)(a.heartbeats).concat(t(J)(e.heartbeats))}));case 12:case"end":return n.stop()}}),n)})))()}}]),e}();function qt(e){return me(JSON.stringify({version:2,heartbeats:e})).length}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */jt="",wt(new Pe("platform-logger",(function(e){return new ct(e)}),"PRIVATE")),wt(new Pe("heartbeat",(function(e){return new Dt(e)}),"PRIVATE")),St(ht,dt,jt),St(ht,dt,"esm2017"),St("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $t(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];throw tr.apply(void 0,[e].concat(t(J)(n)))}function Zt(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];return tr.apply(void 0,[e].concat(t(J)(n)))}function er(e,r,n){var i=Object.assign(Object.assign({},Kt()),t(z)({},r,n));return new ke("auth","Firebase",i).create(r,{appName:e.name})}function tr(e){for(var r=arguments.length,n=new Array(r>1?r-1:0),i=1;i<r;i++)n[i-1]=arguments[i];var a;if("string"!=typeof e){var o,s=n[0],u=t(J)(n.slice(1));return u[0]&&(u[0].appName=e.name),(o=e._errorFactory).create.apply(o,[s].concat(t(J)(u)))}return(a=Yt).create.apply(a,[e].concat(t(J)(n)))}function rr(e,r){for(var n=arguments.length,i=new Array(n>2?n-2:0),a=2;a<n;a++)i[a-2]=arguments[a];if(!e)throw tr.apply(void 0,[r].concat(t(J)(i)))}function nr(e){var t="INTERNAL ASSERTION FAILED: "+e;throw Xt(t),new Error(t)}function ir(e,t){e||nr(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sr(e,t){var r=kt(e,"auth");if(r.isInitialized()){var n=r.getImmediate();if(Ie(r.getOptions(),null!=t?t:{}))return n;$t(n,"already-initialized")}return r.initialize({options:t})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var hr=function(){"use strict";function e(r,n){t(k)(this,e),this.shortDelay=r,this.longDelay=n,ir(n>r,"Short delay should be less than long delay!"),this.isMobile="undefined"!=typeof window&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(be())||"object"==typeof navigator&&"ReactNative"===navigator.product}return t(_)(e,[{key:"get",value:function(){return fr()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}]),e}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dr(e,t){ir(e.emulator,"Emulator should always be set here");var r=e.emulator.url;return t?"".concat(r).concat(t.startsWith("/")?t.slice(1):t):r}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var pr,vr=function(){"use strict";function e(){t(k)(this,e)}return t(_)(e,null,[{key:"initialize",value:function(e,t,r){this.fetchImpl=e,t&&(this.headersImpl=t),r&&(this.responseImpl=r)}},{key:"fetch",value:function(){return this.fetchImpl?this.fetchImpl:"undefined"!=typeof self&&"fetch"in self?self.fetch:void nr("Could not find fetch implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}},{key:"headers",value:function(){return this.headersImpl?this.headersImpl:"undefined"!=typeof self&&"Headers"in self?self.Headers:void nr("Could not find Headers implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}},{key:"response",value:function(){return this.responseImpl?this.responseImpl:"undefined"!=typeof self&&"Response"in self?self.Response:void nr("Could not find Response implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}}]),e}(),mr=(pr={},t(z)(pr,"CREDENTIAL_MISMATCH","custom-token-mismatch"),t(z)(pr,"MISSING_CUSTOM_TOKEN","internal-error"),t(z)(pr,"INVALID_IDENTIFIER","invalid-email"),t(z)(pr,"MISSING_CONTINUE_URI","internal-error"),t(z)(pr,"INVALID_PASSWORD","wrong-password"),t(z)(pr,"MISSING_PASSWORD","internal-error"),t(z)(pr,"EMAIL_EXISTS","email-already-in-use"),t(z)(pr,"PASSWORD_LOGIN_DISABLED","operation-not-allowed"),t(z)(pr,"INVALID_IDP_RESPONSE","invalid-credential"),t(z)(pr,"INVALID_PENDING_TOKEN","invalid-credential"),t(z)(pr,"FEDERATED_USER_ID_ALREADY_LINKED","credential-already-in-use"),t(z)(pr,"MISSING_REQ_TYPE","internal-error"),t(z)(pr,"EMAIL_NOT_FOUND","user-not-found"),t(z)(pr,"RESET_PASSWORD_EXCEED_LIMIT","too-many-requests"),t(z)(pr,"EXPIRED_OOB_CODE","expired-action-code"),t(z)(pr,"INVALID_OOB_CODE","invalid-action-code"),t(z)(pr,"MISSING_OOB_CODE","internal-error"),t(z)(pr,"CREDENTIAL_TOO_OLD_LOGIN_AGAIN","requires-recent-login"),t(z)(pr,"INVALID_ID_TOKEN","invalid-user-token"),t(z)(pr,"TOKEN_EXPIRED","user-token-expired"),t(z)(pr,"USER_NOT_FOUND","user-token-expired"),t(z)(pr,"TOO_MANY_ATTEMPTS_TRY_LATER","too-many-requests"),t(z)(pr,"INVALID_CODE","invalid-verification-code"),t(z)(pr,"INVALID_SESSION_INFO","invalid-verification-id"),t(z)(pr,"INVALID_TEMPORARY_PROOF","invalid-credential"),t(z)(pr,"MISSING_SESSION_INFO","missing-verification-id"),t(z)(pr,"SESSION_EXPIRED","code-expired"),t(z)(pr,"MISSING_ANDROID_PACKAGE_NAME","missing-android-pkg-name"),t(z)(pr,"UNAUTHORIZED_DOMAIN","unauthorized-continue-uri"),t(z)(pr,"INVALID_OAUTH_CLIENT_ID","invalid-oauth-client-id"),t(z)(pr,"ADMIN_ONLY_OPERATION","admin-restricted-operation"),t(z)(pr,"INVALID_MFA_PENDING_CREDENTIAL","invalid-multi-factor-session"),t(z)(pr,"MFA_ENROLLMENT_NOT_FOUND","multi-factor-info-not-found"),t(z)(pr,"MISSING_MFA_ENROLLMENT_ID","missing-multi-factor-info"),t(z)(pr,"MISSING_MFA_PENDING_CREDENTIAL","missing-multi-factor-session"),t(z)(pr,"SECOND_FACTOR_EXISTS","second-factor-already-in-use"),t(z)(pr,"SECOND_FACTOR_LIMIT_EXCEEDED","maximum-second-factor-count-exceeded"),t(z)(pr,"BLOCKING_FUNCTION_ERROR_RESPONSE","internal-error"),pr),gr=new hr(3e4,6e4);function yr(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}function br(e,t,r,n){return wr.apply(this,arguments)}function wr(){return wr=t(g)(t(b).mark((function e(r,n,i,a){var o,s=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return o=s.length>4&&void 0!==s[4]?s[4]:{},e.abrupt("return",kr(r,o,t(g)(t(b).mark((function e(){var o,s,u,c;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return o={},s={},a&&("GET"===n?s=a:o={body:JSON.stringify(a)}),u=Se(Object.assign({key:r.config.apiKey},s)).slice(1),e.next=6,r._getAdditionalHeaders();case 6:return(c=e.sent)["Content-Type"]="application/json",r.languageCode&&(c["X-Firebase-Locale"]=r.languageCode),e.abrupt("return",vr.fetch()(Ir(r,r.config.apiHost,i,u),Object.assign({method:n,headers:c,referrerPolicy:"no-referrer"},o)));case 10:case"end":return e.stop()}}),e)})))));case 2:case"end":return e.stop()}}),e)}))),wr.apply(this,arguments)}function kr(e,t,r){return _r.apply(this,arguments)}function _r(){return(_r=t(g)(t(b).mark((function e(r,n,i){var a,o,s,u,c,l,f,h,d;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r._canInitEmulator=!1,a=Object.assign(Object.assign({},mr),n),e.prev=2,o=new Tr(r),e.next=6,Promise.race([i(),o.promise]);case 6:return s=e.sent,o.clearNetworkTimeout(),e.next=10,s.json();case 10:if(!("needConfirmation"in(u=e.sent))){e.next=13;break}throw Sr(r,"account-exists-with-different-credential",u);case 13:if(!s.ok||"errorMessage"in u){e.next=17;break}return e.abrupt("return",u);case 17:if(c=s.ok?u.errorMessage:u.error.message,l=t($)(c.split(" : "),2),f=l[0],h=l[1],"FEDERATED_USER_ID_ALREADY_LINKED"!==f){e.next=23;break}throw Sr(r,"credential-already-in-use",u);case 23:if("EMAIL_EXISTS"!==f){e.next=27;break}throw Sr(r,"email-already-in-use",u);case 27:if("USER_DISABLED"!==f){e.next=29;break}throw Sr(r,"user-disabled",u);case 29:if(d=a[f]||f.toLowerCase().replace(/[_\s]+/g,"-"),!h){e.next=34;break}throw er(r,d,h);case 34:$t(r,d);case 35:e.next=42;break;case 37:if(e.prev=37,e.t0=e.catch(2),!(e.t0 instanceof we)){e.next=41;break}throw e.t0;case 41:$t(r,"network-request-failed");case 42:case"end":return e.stop()}}),e,null,[[2,37]])})))).apply(this,arguments)}function xr(e,t,r,n){return Er.apply(this,arguments)}function Er(){return Er=t(g)(t(b).mark((function e(r,n,i,a){var o,s,u=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return o=u.length>4&&void 0!==u[4]?u[4]:{},e.next=3,br(r,n,i,a,o);case 3:return"mfaPendingCredential"in(s=e.sent)&&$t(r,"multi-factor-auth-required",{_serverResponse:s}),e.abrupt("return",s);case 6:case"end":return e.stop()}}),e)}))),Er.apply(this,arguments)}function Ir(e,t,r,n){var i="".concat(t).concat(r,"?").concat(n);return e.config.emulator?dr(e.config,i):"".concat(e.config.apiScheme,"://").concat(i)}var Tr=function(){"use strict";function e(r){var n=this;t(k)(this,e),this.auth=r,this.timer=null,this.promise=new Promise((function(e,t){var r=n;n.timer=setTimeout((function(){return t(Zt(r.auth,"network-request-failed"))}),gr.get())}))}return t(_)(e,[{key:"clearNetworkTimeout",value:function(){clearTimeout(this.timer)}}]),e}();function Sr(e,t,r){var n={appName:e.name};r.email&&(n.email=r.email),r.phoneNumber&&(n.phoneNumber=r.phoneNumber);var i=Zt(e,t,n);return i.customData._tokenResponse=r,i}function Or(e,t){return Rr.apply(this,arguments)}function Rr(){return(Rr=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",br(r,"POST","/v1/accounts:delete",n));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function Ar(e,t){return Lr.apply(this,arguments)}function Lr(){return(Lr=t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",br(r,"POST","/v1/accounts:lookup",n));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pr(){return Pr=t(g)(t(b).mark((function e(r){var n,i,a,o,s,u,c=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=c.length>1&&void 0!==c[1]&&c[1],i=Ce(r),e.next=4,i.getIdToken(n);case 4:return a=e.sent,rr((o=Mr(a))&&o.exp&&o.auth_time&&o.iat,i.auth,"internal-error"),s="object"==typeof o.firebase?o.firebase:void 0,u=null==s?void 0:s.sign_in_provider,e.abrupt("return",{claims:o,token:a,authTime:Cr(Nr(o.auth_time)),issuedAtTime:Cr(Nr(o.iat)),expirationTime:Cr(Nr(o.exp)),signInProvider:u||null,signInSecondFactor:(null==s?void 0:s.sign_in_second_factor)||null});case 10:case"end":return e.stop()}}),e)}))),Pr.apply(this,arguments)}function Nr(e){return 1e3*Number(e)}function Mr(e){var r,n=t($)(e.split("."),3),i=n[0],a=n[1],o=n[2];if(void 0===i||void 0===a||void 0===o)return Xt("JWT malformed, contained fewer than 3 sections"),null;try{var s=ge(a);return s?JSON.parse(s):(Xt("Failed to decode base64 JWT payload"),null)}catch(e){return Xt("Caught error parsing JWT payload as JSON",null===(r=e)||void 0===r?void 0:r.toString()),null}}function Dr(e,t){return Br.apply(this,arguments)}function Br(){return Br=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r,n){var i=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(!(i.length>2&&void 0!==i[2]&&i[2])){e.next=3;break}return e.abrupt("return",n);case 3:return e.prev=3,e.next=6,n;case 6:return e.abrupt("return",e.sent);case 9:if(e.prev=9,e.t0=e.catch(3),!(e.t0 instanceof we&&Ur(e.t0))){e.next=15;break}if(r.auth.currentUser!==r){e.next=15;break}return e.next=15,r.auth.signOut();case 15:throw e.t0;case 16:case"end":return e.stop()}}),e,null,[[3,9]])}))),Br.apply(this,arguments)}function Ur(e){var t=e.code;return"auth/user-disabled"===t||"auth/user-token-expired"===t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qr(e){return Hr.apply(this,arguments)}function Hr(){return(Hr=
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r){var n,i,a,o,s,u,c,l,f,h,d;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=r.auth,e.next=4,r.getIdToken();case 4:return a=e.sent,e.next=7,Dr(r,Ar(i,{idToken:a}));case 7:rr(null==(o=e.sent)?void 0:o.users.length,i,"internal-error"),s=o.users[0],r._notifyReloadListener(s),u=(null===(n=s.providerUserInfo)||void 0===n?void 0:n.length)?zr(s.providerUserInfo):[],c=Wr(r.providerData,u),l=r.isAnonymous,f=!(r.email&&s.passwordHash||(null==c?void 0:c.length)),h=!!l&&f,d={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:c,metadata:new Fr(s.createdAt,s.lastLoginAt),isAnonymous:h},Object.assign(r,d);case 18:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function Vr(){return(Vr=t(g)(t(b).mark((function e(r){var n;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=Ce(r),e.next=3,qr(n);case 3:return e.next=5,n.auth._persistUserIfCurrent(n);case 5:n.auth._notifyListenersIfCurrent(n);case 6:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function Wr(e,r){var n=e.filter((function(e){return!r.some((function(t){return t.providerId===e.providerId}))}));return t(J)(n).concat(t(J)(r))}function zr(e){return e.map((function(e){var t=e.providerId,r=Jt(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}}))}function Jr(e,t){return Gr.apply(this,arguments)}function Gr(){return(Gr=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Kr=function(){"use strict";function e(){t(k)(this,e),this.refreshToken=null,this.accessToken=null,this.expirationTime=null}return t(_)(e,[{key:"isExpired",get:function(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}},{key:"updateFromServerResponse",value:function(e){rr(e.idToken,"internal-error"),rr(void 0!==e.idToken,"internal-error"),rr(void 0!==e.refreshToken,"internal-error");var t,r,n="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):(t=e.idToken,rr(r=Mr(t),"internal-error"),rr(void 0!==r.exp,"internal-error"),rr(void 0!==r.iat,"internal-error"),Number(r.exp)-Number(r.iat));this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}},{key:"getToken",value:function(e){var r=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=this;return t(g)(t(b).mark((function i(){return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(rr(!n.accessToken||n.refreshToken,e,"user-token-expired"),r||!n.accessToken||n.isExpired){t.next=3;break}return t.abrupt("return",n.accessToken);case 3:if(!n.refreshToken){t.next=7;break}return t.next=6,n.refresh(e,n.refreshToken);case 6:return t.abrupt("return",n.accessToken);case 7:return t.abrupt("return",null);case 8:case"end":return t.stop()}}),i)})))()}},{key:"clearRefreshToken",value:function(){this.refreshToken=null}},{key:"refresh",value:function(e,r){var n=this;return t(g)(t(b).mark((function i(){var a,o,s,u;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,Jr(e,r);case 2:a=t.sent,o=a.accessToken,s=a.refreshToken,u=a.expiresIn,n.updateTokensAndExpiration(o,s,Number(u));case 7:case"end":return t.stop()}}),i)})))()}},{key:"updateTokensAndExpiration",value:function(e,t,r){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+1e3*r}},{key:"toJSON",value:function(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}},{key:"_assign",value:function(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}},{key:"_clone",value:function(){return Object.assign(new e,this.toJSON())}},{key:"_performRefresh",value:function(){return nr("not implemented")}}],[{key:"fromJSON",value:function(t,r){var n=r.refreshToken,i=r.accessToken,a=r.expirationTime,o=new e;return n&&(rr("string"==typeof n,"internal-error",{appName:t}),o.refreshToken=n),i&&(rr("string"==typeof i,"internal-error",{appName:t}),o.accessToken=i),a&&(rr("number"==typeof a,"internal-error",{appName:t}),o.expirationTime=a),o}}]),e}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tn(e){var t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(on(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(rn(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(un(t))return"Blackberry";if(cn(t))return"Webos";if(nn(t))return"Safari";if((t.includes("chrome/")||an(t))&&!t.includes("edge/"))return"Chrome";if(sn(t))return"Android";var r=e.match(/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/);return 2===(null==r?void 0:r.length)?r[1]:"Other"}function rn(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:be();return/firefox\//i.test(e)}function nn(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:be(),t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function an(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:be();return/crios\//i.test(e)}function on(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:be();return/iemobile/i.test(e)}function sn(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:be();return/android/i.test(e)}function un(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:be();return/blackberry/i.test(e)}function cn(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:be();return/webos/i.test(e)}function ln(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:be();return/iphone|ipad|ipod/i.test(e)}function fn(){var e,t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:be();return ln(t)&&!!(null===(e=window.navigator)||void 0===e?void 0:e.standalone)}function hn(){return((e=be()).indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0)&&10===document.documentMode;var e}function dn(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:be();return ln(e)||sn(e)||cn(e)||un(e)||/windows phone/i.test(e)||on(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function pn(e){var t,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[];switch(e){case"Browser":t=tn(be());break;case"Worker":t="".concat(tn(be()),"-").concat(e);break;default:t=e}var n=r.length?r.join(","):"FirebaseCore-web";return"".concat(t,"/","JsCore","/").concat(It,"/").concat(n)}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gn(e){return Ce(e)}var yn=function(){"use strict";function e(r){var n,i,a=this;t(k)(this,e),this.auth=r,this.observer=null,this.addObserver=(i=new Ae((function(e){return a.observer=e}),n)).subscribe.bind(i)}return t(_)(e,[{key:"next",get:function(){return rr(this.observer,this.auth,"internal-error"),this.observer.next.bind(this.observer)}}]),e}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var bn=function(){"use strict";function e(r,n){t(k)(this,e),this.providerId=r,this.signInMethod=n}return t(_)(e,[{key:"toJSON",value:function(){return nr("not implemented")}},{key:"_getIdTokenResponse",value:function(e){return nr("not implemented")}},{key:"_linkToIdToken",value:function(e,t){return nr("not implemented")}},{key:"_getReauthenticationResolver",value:function(e){return nr("not implemented")}}]),e}();function wn(e,t){return kn.apply(this,arguments)}function kn(){return(kn=t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",br(r,"POST","/v1/accounts:update",n));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function _n(e,t){return xn.apply(this,arguments)}function xn(){return(xn=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",xr(r,"POST","/v1/accounts:signInWithPassword",yr(r,n)));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function En(e,t){return In.apply(this,arguments)}function In(){return(In=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",xr(r,"POST","/v1/accounts:signInWithEmailLink",yr(r,n)));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function Tn(e,t){return Sn.apply(this,arguments)}function Sn(){return(Sn=t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",xr(r,"POST","/v1/accounts:signInWithEmailLink",yr(r,n)));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var On=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(e,i,a){var o,s=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return t(k)(this,n),(o=r.call(this,"password",a))._email=e,o._password=i,o._tenantId=s,o}return t(_)(n,[{key:"toJSON",value:function(){return{email:this._email,password:this._password,signInMethod:this.signInMethod,tenantId:this._tenantId}}},{key:"_getIdTokenResponse",value:function(e){var r=this;return t(g)(t(b).mark((function n(){return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:t.t0=r.signInMethod,t.next="password"===t.t0?3:"emailLink"===t.t0?4:5;break;case 3:return t.abrupt("return",_n(e,{returnSecureToken:!0,email:r._email,password:r._password}));case 4:return t.abrupt("return",En(e,{email:r._email,oobCode:r._password}));case 5:$t(e,"internal-error");case 6:case"end":return t.stop()}}),n)})))()}},{key:"_linkToIdToken",value:function(e,r){var n=this;return t(g)(t(b).mark((function i(){return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:t.t0=n.signInMethod,t.next="password"===t.t0?3:"emailLink"===t.t0?4:5;break;case 3:return t.abrupt("return",wn(e,{idToken:r,returnSecureToken:!0,email:n._email,password:n._password}));case 4:return t.abrupt("return",Tn(e,{idToken:r,email:n._email,oobCode:n._password}));case 5:$t(e,"internal-error");case 6:case"end":return t.stop()}}),i)})))()}},{key:"_getReauthenticationResolver",value:function(e){return this._getIdTokenResponse(e)}}],[{key:"_fromEmailAndPassword",value:function(e,t){return new n(e,t,"password")}},{key:"_fromEmailAndCode",value:function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return new n(e,t,"emailLink",r)}},{key:"fromJSON",value:function(e){var t="string"==typeof e?JSON.parse(e):e;if((null==t?void 0:t.email)&&(null==t?void 0:t.password)){if("password"===t.signInMethod)return this._fromEmailAndPassword(t.email,t.password);if("emailLink"===t.signInMethod)return this._fromEmailAndCode(t.email,t.password,t.tenantId)}return null}}]),n}(bn);function Rn(e,t){return An.apply(this,arguments)}function An(){return(An=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",xr(r,"POST","/v1/accounts:signInWithIdp",yr(r,n)));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",br(r,"POST","/v1/accounts:sendVerificationCode",yr(r,n)));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function Nn(){return(Nn=t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",xr(r,"POST","/v1/accounts:signInWithPhoneNumber",yr(r,n)));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function Mn(){return(Mn=t(g)(t(b).mark((function e(r,n){var i;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,xr(r,"POST","/v1/accounts:signInWithPhoneNumber",yr(r,n));case 2:if(!(i=e.sent).temporaryProof){e.next=5;break}throw Sr(r,"account-exists-with-different-credential",i);case 5:return e.abrupt("return",i);case 6:case"end":return e.stop()}}),e)})))).apply(this,arguments)}var Dn=t(z)({},"USER_NOT_FOUND","user-not-found");function Bn(){return(Bn=t(g)(t(b).mark((function e(r,n){var i;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=Object.assign(Object.assign({},n),{operation:"REAUTH"}),e.abrupt("return",xr(r,"POST","/v1/accounts:signInWithPhoneNumber",yr(r,i),Dn));case 2:case"end":return e.stop()}}),e)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var Fn=function(){"use strict";function e(){t(k)(this,e),this.providerId=e.PROVIDER_ID}return t(_)(e,null,[{key:"credential",value:function(e,t){return On._fromEmailAndPassword(e,t)}},{key:"credentialWithLink",value:function(e,t){var r=jn.parseLink(t);return rr(r,"argument-error"),On._fromEmailAndCode(e,r.code,r.tenantId)}}]),e}();Fn.PROVIDER_ID="password",Fn.EMAIL_PASSWORD_SIGN_IN_METHOD="password",Fn.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var qn=function(){"use strict";function e(r){t(k)(this,e),this.providerId=r,this.defaultLanguageCode=null,this.customParameters={}}return t(_)(e,[{key:"setDefaultLanguage",value:function(e){this.defaultLanguageCode=e}},{key:"setCustomParameters",value:function(e){return this.customParameters=e,this}},{key:"getCustomParameters",value:function(){return this.customParameters}}]),e}(),Hn=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(){var e;return t(k)(this,n),(e=r.call.apply(r,[this].concat(Array.prototype.slice.call(arguments)))).scopes=[],e}return t(_)(n,[{key:"addScope",value:function(e){return this.scopes.includes(e)||this.scopes.push(e),this}},{key:"getScopes",value:function(){return t(J)(this.scopes)}}]),n}(qn),Vn=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(){return t(k)(this,n),r.call(this,"facebook.com")}return t(_)(n,null,[{key:"credential",value:function(e){return Ln._fromParams({providerId:n.PROVIDER_ID,signInMethod:n.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}},{key:"credentialFromResult",value:function(e){return n.credentialFromTaggedObject(e)}},{key:"credentialFromError",value:function(e){return n.credentialFromTaggedObject(e.customData||{})}},{key:"credentialFromTaggedObject",value:function(e){var t=e._tokenResponse;if(!t||!("oauthAccessToken"in t))return null;if(!t.oauthAccessToken)return null;try{return n.credential(t.oauthAccessToken)}catch(e){return null}}}]),n}(Hn);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var Wn=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(){var e;return t(k)(this,n),(e=r.call(this,"google.com")).addScope("profile"),e}return t(_)(n,null,[{key:"credential",value:function(e,t){return Ln._fromParams({providerId:n.PROVIDER_ID,signInMethod:n.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}},{key:"credentialFromResult",value:function(e){return n.credentialFromTaggedObject(e)}},{key:"credentialFromError",value:function(e){return n.credentialFromTaggedObject(e.customData||{})}},{key:"credentialFromTaggedObject",value:function(e){var t=e._tokenResponse;if(!t)return null;var r=t.oauthIdToken,i=t.oauthAccessToken;if(!r&&!i)return null;try{return n.credential(r,i)}catch(e){return null}}}]),n}(Hn);Wn.GOOGLE_SIGN_IN_METHOD="google.com",Wn.PROVIDER_ID="google.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var zn=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(){return t(k)(this,n),r.call(this,"github.com")}return t(_)(n,null,[{key:"credential",value:function(e){return Ln._fromParams({providerId:n.PROVIDER_ID,signInMethod:n.GITHUB_SIGN_IN_METHOD,accessToken:e})}},{key:"credentialFromResult",value:function(e){return n.credentialFromTaggedObject(e)}},{key:"credentialFromError",value:function(e){return n.credentialFromTaggedObject(e.customData||{})}},{key:"credentialFromTaggedObject",value:function(e){var t=e._tokenResponse;if(!t||!("oauthAccessToken"in t))return null;if(!t.oauthAccessToken)return null;try{return n.credential(t.oauthAccessToken)}catch(e){return null}}}]),n}(Hn);zn.GITHUB_SIGN_IN_METHOD="github.com",zn.PROVIDER_ID="github.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var Jn=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(){return t(k)(this,n),r.call(this,"twitter.com")}return t(_)(n,null,[{key:"credential",value:function(e,t){return Ln._fromParams({providerId:n.PROVIDER_ID,signInMethod:n.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}},{key:"credentialFromResult",value:function(e){return n.credentialFromTaggedObject(e)}},{key:"credentialFromError",value:function(e){return n.credentialFromTaggedObject(e.customData||{})}},{key:"credentialFromTaggedObject",value:function(e){var t=e._tokenResponse;if(!t)return null;var r=t.oauthAccessToken,i=t.oauthTokenSecret;if(!r||!i)return null;try{return n.credential(r,i)}catch(e){return null}}}]),n}(Hn);function Gn(e,t){return Kn.apply(this,arguments)}function Kn(){return(Kn=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",xr(r,"POST","/v1/accounts:signUp",yr(r,n)));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Jn.TWITTER_SIGN_IN_METHOD="twitter.com",Jn.PROVIDER_ID="twitter.com";var Yn=function(){"use strict";function e(r){t(k)(this,e),this.user=r.user,this.providerId=r.providerId,this._tokenResponse=r._tokenResponse,this.operationType=r.operationType}return t(_)(e,null,[{key:"_fromIdTokenResponse",value:function(r,n,i){var a=arguments.length>3&&void 0!==arguments[3]&&arguments[3];return t(g)(t(b).mark((function o(){var s,u,c;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,Qr._fromIdTokenResponse(r,i,a);case 2:return s=t.sent,u=Qn(i),c=new e({user:s,providerId:u,_tokenResponse:i,operationType:n}),t.abrupt("return",c);case 6:case"end":return t.stop()}}),o)})))()}},{key:"_forOperation",value:function(r,n,i){return t(g)(t(b).mark((function a(){var o;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,r._updateTokensIfNecessary(i,!0);case 2:return o=Qn(i),t.abrupt("return",new e({user:r,providerId:o,_tokenResponse:i,operationType:n}));case 4:case"end":return t.stop()}}),a)})))()}}]),e}();function Qn(e){return e.providerId?e.providerId:"phoneNumber"in e?"phone":null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var Xn=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(e,i,a,o){var s,u;return t(k)(this,n),(s=r.call(this,i.code,i.message)).operationType=a,s.user=o,Object.setPrototypeOf(t(ie)(s),n.prototype),s.customData={appName:e.name,tenantId:null!==(u=e.tenantId)&&void 0!==u?u:void 0,_serverResponse:i.customData._serverResponse,operationType:a},s}return t(_)(n,null,[{key:"_fromErrorAndOperation",value:function(e,t,r,i){return new n(e,t,r,i)}}]),n}(we);function $n(e,t,r,n){return("reauthenticate"===t?r._getReauthenticationResolver(e):r._getIdTokenResponse(e)).catch((function(r){if("auth/multi-factor-auth-required"===r.code)throw Xn._fromErrorAndOperation(e,r,t,n);throw r}))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zn(e,t){return ei.apply(this,arguments)}function ei(){return ei=t(g)(t(b).mark((function e(r,n){var i,a,o=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=o.length>2&&void 0!==o[2]&&o[2],e.t0=Dr,e.t1=r,e.t2=n,e.t3=r.auth,e.next=7,r.getIdToken();case 7:return e.t4=e.sent,e.t5=e.t2._linkToIdToken.call(e.t2,e.t3,e.t4),e.t6=i,e.next=12,(0,e.t0)(e.t1,e.t5,e.t6);case 12:return a=e.sent,e.abrupt("return",Yn._forOperation(r,"link",a));case 14:case"end":return e.stop()}}),e)}))),ei.apply(this,arguments)}function ti(e,t){return ri.apply(this,arguments)}function ri(){return ri=
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r,n){var i,a,o,s,u,c,l,f=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=f.length>2&&void 0!==f[2]&&f[2],o=r.auth,s="reauthenticate",e.prev=4,e.next=7,Dr(r,$n(o,s,n,r),i);case 7:return rr((u=e.sent).idToken,o,"internal-error"),rr(c=Mr(u.idToken),o,"internal-error"),l=c.sub,rr(r.uid===l,o,"user-mismatch"),e.abrupt("return",Yn._forOperation(r,s,u));case 16:throw e.prev=16,e.t0=e.catch(4),"auth/user-not-found"===(null===(a=e.t0)||void 0===a?void 0:a.code)&&$t(o,"user-mismatch"),e.t0;case 20:case"end":return e.stop()}}),e,null,[[4,16]])}))),ri.apply(this,arguments)}function ni(e,t){return ii.apply(this,arguments)}function ii(){return ii=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r,n){var i,a,o,s,u=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=u.length>2&&void 0!==u[2]&&u[2],a="signIn",e.next=4,$n(r,a,n);case 4:return o=e.sent,e.next=7,Yn._fromIdTokenResponse(r,a,o);case 7:if(s=e.sent,i){e.next=11;break}return e.next=11,r._updateCurrentUser(s.user);case 11:return e.abrupt("return",s);case 12:case"end":return e.stop()}}),e)}))),ii.apply(this,arguments)}function ai(e,t){return oi.apply(this,arguments)}function oi(){return(oi=t(g)(t(b).mark((function e(r,n){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",ni(gn(r),n));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function si(e,t,r){return ui.apply(this,arguments)}function ui(){return(ui=t(g)(t(b).mark((function e(r,n,i){var a,o,s;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return a=gn(r),e.next=3,Gn(a,{returnSecureToken:!0,email:n,password:i});case 3:return o=e.sent,e.next=6,Yn._fromIdTokenResponse(a,"signIn",o);case 6:return s=e.sent,e.next=9,a._updateCurrentUser(s.user);case 9:return e.abrupt("return",s);case 10:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function ci(e,t,r){return ai(Ce(e),Fn.credential(t,r))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var yi=function(){"use strict";function e(r){t(k)(this,e),this.eventTarget=r,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}return t(_)(e,[{key:"isListeningto",value:function(e){return this.eventTarget===e}},{key:"handleEvent",value:function(e){var r=this;return t(g)(t(b).mark((function n(){var i,a,o,s,u,c,l,f;return t(b).wrap((function(n){for(;;)switch(n.prev=n.next){case 0:if(a=(i=e).data,o=a.eventId,s=a.eventType,u=a.data,null==(c=r.handlersMap[s])?void 0:c.size){n.next=5;break}return n.abrupt("return");case 5:return i.ports[0].postMessage({status:"ack",eventId:o,eventType:s}),l=Array.from(c).map(function(){var e=t(g)(t(b).mark((function e(r){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",r(i.origin,u));case 1:case"end":return e.stop()}}),e)})));return function(t){return e.apply(this,arguments)}}()),n.next=9,gi(l);case 9:f=n.sent,i.ports[0].postMessage({status:"done",eventId:o,eventType:s,response:f});case 11:case"end":return n.stop()}}),n)})))()}},{key:"_subscribe",value:function(e,t){0===Object.keys(this.handlersMap).length&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}},{key:"_unsubscribe",value:function(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),t&&0!==this.handlersMap[e].size||delete this.handlersMap[e],0===Object.keys(this.handlersMap).length&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}],[{key:"_getInstance",value:function(t){var r=this.receivers.find((function(e){return e.isListeningto(t)}));if(r)return r;var n=new e(t);return this.receivers.push(n),n}}]),e}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */yi.receivers=[];var wi=function(){"use strict";function e(r){t(k)(this,e),this.target=r,this.handlers=new Set}return t(_)(e,[{key:"removeMessageHandler",value:function(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}},{key:"_send",value:function(e,r){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:50,i=this;return t(g)(t(b).mark((function a(){var o,s,u;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(o="undefined"!=typeof MessageChannel?new MessageChannel:null){t.next=3;break}throw new Error("connection_unavailable");case 3:return t.abrupt("return",new Promise((function(t,a){var c=bi("",20);o.port1.start();var l=setTimeout((function(){a(new Error("unsupported_event"))}),n);u={messageChannel:o,onMessage:function(e){var r=e;if(r.data.eventId===c)switch(r.data.status){case"ack":clearTimeout(l),s=setTimeout((function(){a(new Error("timeout"))}),3e3);break;case"done":clearTimeout(s),t(r.data.response);break;default:clearTimeout(l),clearTimeout(s),a(new Error("invalid_response"))}}},i.handlers.add(u),o.port1.addEventListener("message",u.onMessage),i.target.postMessage({eventType:e,eventId:c,data:r},[o.port2])})).finally((function(){u&&i.removeMessageHandler(u)})));case 6:case"end":return t.stop()}}),a)})))()}}]),e}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ji(e,t){return br(e,"POST","/v2/accounts/mfaSignIn:start",yr(e,t))}function Fi(e){return new Promise((function(t,r){var n,i,a=document.createElement("script");a.setAttribute("src",e),a.onload=t,a.onerror=function(e){var t=Zt("internal-error");t.customData=e,r(t)},a.type="text/javascript",a.charset="UTF-8",(null!==(i=null===(n=document.getElementsByTagName("head"))||void 0===n?void 0:n[0])&&void 0!==i?i:document).appendChild(a)}))}function qi(e){return"__".concat(e).concat(Math.floor(1e6*Math.random()))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
qi("rcb"),new hr(3e4,6e4);var Hi="recaptcha";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var zi=function(){"use strict";function e(r){t(k)(this,e),this.providerId=e.PROVIDER_ID,this.auth=gn(r)}return t(_)(e,[{key:"verifyPhoneNumber",value:function(e,t){return Vi(this.auth,e,Ce(t))}}],[{key:"credential",value:function(e,t){return Un._fromVerification(e,t)}},{key:"credentialFromResult",value:function(t){var r=t;return e.credentialFromTaggedObject(r)}},{key:"credentialFromError",value:function(t){return e.credentialFromTaggedObject(t.customData||{})}},{key:"credentialFromTaggedObject",value:function(e){var t=e._tokenResponse;if(!t)return null;var r=t.phoneNumber,n=t.temporaryProof;return r&&n?Un._fromTokenResponse(r,n):null}}]),e}();
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */zi.PROVIDER_ID="phone",zi.PHONE_SIGN_IN_METHOD="phone";var Gi=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(e){var i;return t(k)(this,n),(i=r.call(this,"custom","custom")).params=e,i}return t(_)(n,[{key:"_getIdTokenResponse",value:function(e){return Rn(e,this._buildIdpRequest())}},{key:"_linkToIdToken",value:function(e,t){return Rn(e,this._buildIdpRequest(t))}},{key:"_getReauthenticationResolver",value:function(e){return Rn(e,this._buildIdpRequest())}},{key:"_buildIdpRequest",value:function(e){var t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}]),n}(bn);function Ki(e){return ni(e.auth,new Gi(e),e.bypassAuthState)}function Yi(e){var t=e.auth,r=e.user;return rr(r,t,"internal-error"),ti(r,new Gi(e),e.bypassAuthState)}function Qi(e){return Xi.apply(this,arguments)}function Xi(){return(Xi=t(g)(t(b).mark((function e(r){var n,i;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=r.auth,rr(i=r.user,n,"internal-error"),e.abrupt("return",Zn(i,new Gi(r),r.bypassAuthState));case 3:case"end":return e.stop()}}),e)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ea=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(e,i,a,o,s){var u;return t(k)(this,n),(u=r.call(this,e,i,o,s)).provider=a,u.authWindow=null,u.pollId=null,n.currentPopupAction&&n.currentPopupAction.cancel(),n.currentPopupAction=t(ie)(u),u}return t(_)(n,[{key:"executeNotNull",value:function(){var e=this;return t(g)(t(b).mark((function r(){var n;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,e.execute();case 2:return rr(n=t.sent,e.auth,"internal-error"),t.abrupt("return",n);case 5:case"end":return t.stop()}}),r)})))()}},{key:"onExecution",value:function(){var e=this;return t(g)(t(b).mark((function r(){var n;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return ir(1===e.filter.length,"Popup operations only handle one event"),n=bi(),t.next=4,e.resolver._openPopup(e.auth,e.provider,e.filter[0],n);case 4:e.authWindow=t.sent,e.authWindow.associatedEvent=n,e.resolver._originValidation(e.auth).catch((function(t){e.reject(t)})),e.resolver._isIframeWebStorageSupported(e.auth,(function(t){t||e.reject(Zt(e.auth,"web-storage-unsupported"))})),e.pollUserCancellation();case 9:case"end":return t.stop()}}),r)})))()}},{key:"eventId",get:function(){var e;return(null===(e=this.authWindow)||void 0===e?void 0:e.associatedEvent)||null}},{key:"cancel",value:function(){this.reject(Zt(this.auth,"cancelled-popup-request"))}},{key:"cleanUp",value:function(){this.authWindow&&this.authWindow.close(),this.pollId&&window.clearTimeout(this.pollId),this.authWindow=null,this.pollId=null,n.currentPopupAction=null}},{key:"pollUserCancellation",value:function(){var e=this,t=function(){var r,n;if(null===(n=null===(r=e.authWindow)||void 0===r?void 0:r.window)||void 0===n?void 0:n.closed){var i=e;e.pollId=window.setTimeout((function(){i.pollId=null,i.reject(Zt(i.auth,"popup-closed-by-user"))}),2e3)}else e.pollId=window.setTimeout(t,Zi.get())};t()}}]),n}($i);ea.currentPopupAction=null;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var ta=new Map,ra=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(e,i){var a,o=arguments.length>2&&void 0!==arguments[2]&&arguments[2];return t(k)(this,n),(a=r.call(this,e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],i,void 0,o)).eventId=null,a}return t(_)(n,[{key:"execute",value:function(){var e=this,r=this;return t(g)(t(b).mark((function i(){var a,o;return t(b).wrap((function(i){for(;;)switch(i.prev=i.next){case 0:if(a=ta.get(r.auth._key())){i.next=21;break}return i.prev=2,i.next=5,na(r.resolver,r.auth);case 5:if(!i.sent){i.next=12;break}return i.next=9,t(Ht)(t(zt)(n.prototype),"execute",e).call(r);case 9:i.t0=i.sent,i.next=13;break;case 12:i.t0=null;case 13:o=i.t0,a=function(){return Promise.resolve(o)},i.next=20;break;case 17:i.prev=17,i.t1=i.catch(2),a=function(){return Promise.reject(i.t1)};case 20:ta.set(r.auth._key(),a);case 21:return r.bypassAuthState||ta.set(r.auth._key(),(function(){return Promise.resolve(null)})),i.abrupt("return",a());case 23:case"end":return i.stop()}}),i,null,[[2,17]])})))()}},{key:"onAuthEvent",value:function(e){var r=this,i=this,a=function(){return t(Ht)(t(zt)(n.prototype),"onAuthEvent",r)};return t(g)(t(b).mark((function r(){var n;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if("signInViaRedirect"!==e.type){t.next=4;break}return t.abrupt("return",a().call(i,e));case 4:if("unknown"!==e.type){t.next=7;break}return i.resolve(null),t.abrupt("return");case 7:if(!e.eventId){t.next=17;break}return t.next=10,i.auth._redirectUserForId(e.eventId);case 10:if(!(n=t.sent)){t.next=16;break}return i.user=n,t.abrupt("return",a().call(i,e));case 16:i.resolve(null);case 17:case"end":return t.stop()}}),r)})))()}},{key:"onExecution",value:function(){return t(g)(t(b).mark((function e(){return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:case"end":return e.stop()}}),e)})))()}},{key:"cleanUp",value:function(){}}]),n}($i);function na(e,t){return ia.apply(this,arguments)}function ia(){return(ia=t(g)(t(b).mark((function e(r,n){var i,a,o;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=sa(n),a=oa(r),e.next=4,a._isAvailable();case 4:if(e.sent){e.next=6;break}return e.abrupt("return",!1);case 6:return e.next=8,a._get(i);case 8:return e.t0=e.sent,o="true"===e.t0,e.next=12,a._remove(i);case 12:return e.abrupt("return",o);case 13:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function aa(e,t){ta.set(e._key(),t)}function oa(e){return or(e._redirectPersistence)}function sa(e){return Zr("pendingRedirect",e.config.apiKey,e.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ua(e,t){return ca.apply(this,arguments)}function ca(){return ca=t(g)(t(b).mark((function e(r,n){var i,a,o,s,u,c=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return i=c.length>2&&void 0!==c[2]&&c[2],a=gn(r),o=Ji(a,n),s=new ra(a,o,i),e.next=6,s.execute();case 6:if(!(u=e.sent)||i){e.next=13;break}return delete u.user._redirectEventId,e.next=11,a._persistUserIfCurrent(u.user);case 11:return e.next=13,a._setRedirectUser(null,n);case 13:return e.abrupt("return",u);case 14:case"end":return e.stop()}}),e)}))),ca.apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var la=function(){"use strict";function e(r){t(k)(this,e),this.auth=r,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}return t(_)(e,[{key:"registerConsumer",value:function(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}},{key:"unregisterConsumer",value:function(e){this.consumers.delete(e)}},{key:"onEvent",value:function(e){var t=this;if(this.hasEventBeenHandled(e))return!1;var r=!1;return this.consumers.forEach((function(n){t.isEventForConsumer(e,n)&&(r=!0,t.sendToConsumer(e,n),t.saveEventToCache(e))})),this.hasHandledPotentialRedirect||!function(e){switch(e.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return ha(e);default:return!1}}(e)||(this.hasHandledPotentialRedirect=!0,r||(this.queuedRedirectEvent=e,r=!0)),r}},{key:"sendToConsumer",value:function(e,t){var r;if(e.error&&!ha(e)){var n=(null===(r=e.error.code)||void 0===r?void 0:r.split("auth/")[1])||"internal-error";t.onError(Zt(this.auth,n))}else t.onAuthEvent(e)}},{key:"isEventForConsumer",value:function(e,t){var r=null===t.eventId||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&r}},{key:"hasEventBeenHandled",value:function(e){return Date.now()-this.lastProcessedEventTime>=6e5&&this.cachedEventUids.clear(),this.cachedEventUids.has(fa(e))}},{key:"saveEventToCache",value:function(e){this.cachedEventUids.add(fa(e)),this.lastProcessedEventTime=Date.now()}}]),e}();function fa(e){return[e.type,e.eventId,e.sessionId,e.tenantId].filter((function(e){return e})).join("-")}function ha(e){var t=e.type,r=e.error;return"unknown"===t&&"auth/no-auth-event"===(null==r?void 0:r.code)}function da(e){return pa.apply(this,arguments)}function pa(){return pa=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
t(g)(t(b).mark((function e(r){var n,i=arguments;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=i.length>1&&void 0!==i[1]?i[1]:{},e.abrupt("return",br(r,"GET","/v1/projects",n));case 2:case"end":return e.stop()}}),e)}))),pa.apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ba=new hr(3e4,6e4);function wa(){var e=ki().___jsl,r=!0,n=!1,i=void 0;if(null==e?void 0:e.H)try{for(var a,o=Object.keys(e.H)[Symbol.iterator]();!(r=(a=o.next()).done);r=!0){var s=a.value;if(e.H[s].r=e.H[s].r||[],e.H[s].L=e.H[s].L||[],e.H[s].r=t(J)(e.H[s].L),e.CP)for(var u=0;u<e.CP.length;u++)e.CP[u]=null}}catch(e){n=!0,i=e}finally{try{r||null==o.return||o.return()}finally{if(n)throw i}}}var ka=null;function _a(e){return ka=ka||function(e){return new Promise((function(t,r){var n,i,a;function o(){wa(),gapi.load("gapi.iframes",{callback:function(){t(gapi.iframes.getContext())},ontimeout:function(){wa(),r(Zt(e,"network-request-failed"))},timeout:ba.get()})}if(null===(i=null===(n=ki().gapi)||void 0===n?void 0:n.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(a=ki().gapi)||void 0===a?void 0:a.load)){var s=qi("iframefcb");return ki()[s]=function(){gapi.load?o():r(Zt(e,"network-request-failed"))},Fi("https://apis.google.com/js/api.js?onload=".concat(s)).catch((function(e){return r(e)}))}o()}})).catch((function(e){throw ka=null,e}))}(e),ka}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var xa=new hr(5e3,15e3),Ea={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ia=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Ta(e){var t=e.config;rr(t.authDomain,e,"auth-domain-config-required");var r=t.emulator?dr(t,"emulator/auth/iframe"):"https://".concat(e.config.authDomain,"/").concat("__/auth/iframe"),n={apiKey:t.apiKey,appName:e.name,v:It},i=Ia.get(e.config.apiHost);i&&(n.eid=i);var a=e._getFrameworks();return a.length&&(n.fw=a.join(",")),"".concat(r,"?").concat(Se(n).slice(1))}function Sa(e){return Oa.apply(this,arguments)}function Oa(){return Oa=t(g)(t(b).mark((function e(r){var n,i;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,_a(r);case 2:return n=e.sent,rr(i=ki().gapi,r,"internal-error"),e.abrupt("return",n.open({where:document.body,url:Ta(r),messageHandlersFilter:i.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Ea,dontclear:!0},(function(e){return new Promise((n=t(g)(t(b).mark((function n(i,a){var o,s,u;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return u=function(){ki().clearTimeout(s),i(e)},t.next=3,e.restyle({setHideOnLeave:!1});case 3:o=Zt(r,"network-request-failed"),s=ki().setTimeout((function(){a(o)}),xa.get()),e.ping(u).then(u,(function(){a(o)}));case 7:case"end":return t.stop()}}),n)}))),function(e,t){return n.apply(this,arguments)}));var n})));case 6:case"end":return e.stop()}}),e)}))),Oa.apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ra={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Aa="_blank",La="http://localhost",Ca=function(){"use strict";function e(r){t(k)(this,e),this.window=r,this.associatedEvent=null}return t(_)(e,[{key:"close",value:function(){if(this.window)try{this.window.close()}catch(e){}}}]),e}();function Pa(e,r,n){var i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:500,a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:600,o=Math.max((window.screen.availHeight-a)/2,0).toString(),s=Math.max((window.screen.availWidth-i)/2,0).toString(),u="",c=Object.assign(Object.assign({},Ra),{width:i.toString(),height:a.toString(),top:o,left:s}),l=be().toLowerCase();n&&(u=an(l)?Aa:n),rn(l)&&(r=r||La,c.scrollbars="yes");var f=Object.entries(c).reduce((function(e,r){var n=t($)(r,2),i=n[0],a=n[1];return"".concat(e).concat(i,"=").concat(a,",")}),"");if(fn(l)&&"_self"!==u)return Na(r||"",u),new Ca(null);var h=window.open(r||"",u,f);rr(h,e,"popup-blocked");try{h.focus()}catch(e){}return new Ca(h)}function Na(e,t){var r=document.createElement("a");r.href=e,r.target=t;var n=document.createEvent("MouseEvent");n.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),r.dispatchEvent(n)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ma="__/auth/handler",Da="emulator/auth/handler";function Ba(e,r,n,i,a,o){rr(e.config.authDomain,e,"auth-domain-config-required"),rr(e.config.apiKey,e,"invalid-api-key");var s={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:i,v:It,eventId:a};if(r instanceof qn){r.setDefaultLanguage(e.languageCode),s.providerId=r.providerId||"",Ee(r.getCustomParameters())||(s.customParameters=JSON.stringify(r.getCustomParameters()));var u=!0,c=!1,l=void 0;try{for(var f,h=Object.entries(o||{})[Symbol.iterator]();!(u=(f=h.next()).done);u=!0){var d=t($)(f.value,2),p=d[0],v=d[1];s[p]=v}}catch(e){c=!0,l=e}finally{try{u||null==h.return||h.return()}finally{if(c)throw l}}}if(r instanceof Hn){var m=r.getScopes().filter((function(e){return""!==e}));m.length>0&&(s.scopes=m.join(","))}e.tenantId&&(s.tid=e.tenantId);var g,y,b=s,w=!0,k=!1,_=void 0;try{for(var x,E=Object.keys(b)[Symbol.iterator]();!(w=(x=E.next()).done);w=!0){var I=x.value;void 0===b[I]&&delete b[I]}}catch(e){k=!0,_=e}finally{try{w||null==E.return||E.return()}finally{if(k)throw _}}return"".concat((g=e,y=g.config,y.emulator?dr(y,Da):"https://".concat(y.authDomain,"/").concat(Ma)),"?").concat(Se(b).slice(1))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var Ua="webStorageSupport",ja=function(){"use strict";function e(){t(k)(this,e),this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=mi,this._completeRedirectFn=ua,this._overrideRedirectResult=aa}return t(_)(e,[{key:"_openPopup",value:function(e,r,n,i){var a=this;return t(g)(t(b).mark((function o(){var s,u;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return ir(null===(s=a.eventManagers[e._key()])||void 0===s?void 0:s.manager,"_initialize() not called before _openPopup()"),u=Ba(e,r,n,ur(),i),t.abrupt("return",Pa(e,u,bi()));case 4:case"end":return t.stop()}}),o)})))()}},{key:"_openRedirect",value:function(e,r,n,i){var a=this;return t(g)(t(b).mark((function o(){return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,a._originValidation(e);case 2:return o=Ba(e,r,n,ur(),i),ki().location.href=o,t.abrupt("return",new Promise((function(){})));case 4:case"end":return t.stop()}var o}),o)})))()}},{key:"_initialize",value:function(e){var t=this,r=e._key();if(this.eventManagers[r]){var n=this.eventManagers[r],i=n.manager,a=n.promise;return i?Promise.resolve(i):(ir(a,"If manager is not set, promise should be"),a)}var o=this.initAndGetManager(e);return this.eventManagers[r]={promise:o},o.catch((function(){delete t.eventManagers[r]})),o}},{key:"initAndGetManager",value:function(e){var r=this;return t(g)(t(b).mark((function n(){var i,a;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,Sa(e);case 2:return i=t.sent,a=new la(e),i.register("authEvent",(function(t){return rr(null==t?void 0:t.authEvent,e,"invalid-auth-event"),{status:a.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),r.eventManagers[e._key()]={manager:a},r.iframes[e._key()]=i,t.abrupt("return",a);case 8:case"end":return t.stop()}}),n)})))()}},{key:"_isIframeWebStorageSupported",value:function(e,t){this.iframes[e._key()].send(Ua,{type:Ua},(function(r){var n,i=null===(n=null==r?void 0:r[0])||void 0===n?void 0:n.webStorageSupport;void 0!==i&&t(!!i),$t(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}},{key:"_originValidation",value:function(e){var t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=function(e){return ga.apply(this,arguments)}(e)),this.originValidationPromises[t]}},{key:"_shouldInitProactively",get:function(){return dn()||nn()||ln()}}]),e}(),Fa=ja,qa=function(){"use strict";function e(r){t(k)(this,e),this.factorId=r}return t(_)(e,[{key:"_process",value:function(e,t,r){switch(t.type){case"enroll":return this._finalizeEnroll(e,t.credential,r);case"signin":return this._finalizeSignIn(e,t.credential);default:return nr("unexpected MultiFactorSessionType")}}}]),e}(),Ha=function(e){"use strict";t(ae)(n,e);var r=t(de)(n);function n(e){var i;return t(k)(this,n),(i=r.call(this,"phone")).credential=e,i}return t(_)(n,[{key:"_finalizeEnroll",value:function(e,t,r){return function(e,t){return br(e,"POST","/v2/accounts/mfaEnrollment:finalize",yr(e,t))}(e,{idToken:t,displayName:r,phoneVerificationInfo:this.credential._makeVerificationRequest()})}},{key:"_finalizeSignIn",value:function(e,t){return function(e,t){return br(e,"POST","/v2/accounts/mfaSignIn:finalize",yr(e,t))}(e,{mfaPendingCredential:t,phoneVerificationInfo:this.credential._makeVerificationRequest()})}}],[{key:"_fromCredential",value:function(e){return new n(e)}}]),n}(qa);(function(){"use strict";function e(){t(k)(this,e)}return t(_)(e,null,[{key:"assertion",value:function(e){return Ha._fromCredential(e)}}]),e}()).FACTOR_ID="phone";var Va,Wa="@firebase/auth",za="0.20.4",Ja=function(){"use strict";function e(r){t(k)(this,e),this.auth=r,this.internalListeners=new Map}return t(_)(e,[{key:"getUid",value:function(){var e;return this.assertAuthConfigured(),(null===(e=this.auth.currentUser)||void 0===e?void 0:e.uid)||null}},{key:"getToken",value:function(e){var r=this;return t(g)(t(b).mark((function n(){var i;return t(b).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return r.assertAuthConfigured(),t.next=3,r.auth._initializationPromise;case 3:if(r.auth.currentUser){t.next=5;break}return t.abrupt("return",null);case 5:return t.next=7,r.auth.currentUser.getIdToken(e);case 7:return i=t.sent,t.abrupt("return",{accessToken:i});case 9:case"end":return t.stop()}}),n)})))()}},{key:"addAuthTokenListener",value:function(e){if(this.assertAuthConfigured(),!this.internalListeners.has(e)){var t=this.auth.onIdTokenChanged((function(t){var r;e((null===(r=t)||void 0===r?void 0:r.stsTokenManager.accessToken)||null)}));this.internalListeners.set(e,t),this.updateProactiveRefresh()}}},{key:"removeAuthTokenListener",value:function(e){this.assertAuthConfigured();var t=this.internalListeners.get(e);t&&(this.internalListeners.delete(e),t(),this.updateProactiveRefresh())}},{key:"assertAuthConfigured",value:function(){rr(this.auth._initializationPromise,"dependent-sdk-initialized-before-auth")}},{key:"updateProactiveRefresh",value:function(){this.internalListeners.size>0?this.auth._startProactiveRefresh():this.auth._stopProactiveRefresh()}}]),e}();
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ga(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Tt(),t=kt(e,"auth");return t.isInitialized()?t.getImmediate():sr(e,{popupRedirectResolver:Fa,persistence:[Ui,pi,mi]})}Va="Browser",wt(new Pe("auth",(function(e,t){var r=t.options,n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),a=n.options,o=a.apiKey,s=a.authDomain;return function(e,t){rr(o&&!o.includes(":"),"invalid-api-key",{appName:e.name}),rr(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});var n={apiKey:o,authDomain:s,clientPlatform:Va,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:pn(Va)},i=new mn(e,t,n);return function(e,t){var r=(null==t?void 0:t.persistence)||[],n=(Array.isArray(r)?r:[r]).map(or);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(n,null==t?void 0:t.popupRedirectResolver)}(i,r),i}(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((function(e,t,r){e.getProvider("auth-internal").initialize()}))),wt(new Pe("auth-internal",(function(e){var t=gn(e.getProvider("auth").getImmediate());return new Ja(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),St(Wa,za,
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Va)),St(Wa,za,"esm2017");var Ka,Ya,Qa,Xa=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if("object"!=typeof t){var r=t;t={name:r}}var n=Object.assign({name:vt,automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw xt.create("bad-app-name",{appName:String(i)});var a=gt.get(i);if(a){if(Ie(e,a.options)&&Ie(n,a.config))return a;throw xt.create("duplicate-app",{appName:i})}var o=new Ue(i),s=!0,u=!1,c=void 0;try{for(var l,f=yt.values()[Symbol.iterator]();!(s=(l=f.next()).done);s=!0){var h=l.value;o.addComponent(h)}}catch(e){u=!0,c=e}finally{try{s||null==f.return||f.return()}finally{if(u)throw c}}var d=new Et(e,n,o);return gt.set(i,d),d}({apiKey:"AIzaSyC5kyNHcD6sVFejBN9Z00vsOl4bmbW5BXk",authDomain:"filmoteka-teamprojectjs-team6.firebaseapp.com",projectId:"filmoteka-teamprojectjs-team6",storageBucket:"filmoteka-teamprojectjs-team6.appspot.com",messagingSenderId:"421066568411",appId:"1:421066568411:web:c3a2298e24d20ece64d2fe"}),$a=Ga(Xa),Za=document.querySelector("#openModal-auth"),eo=document.querySelector('[name="modal-auth"]'),to=document.querySelector(".modal-auth__email"),ro=document.querySelector(".modal-auth__password"),no=document.querySelector(".modal-auth__btn--login"),io=document.querySelector(".modal-auth__btn--logout"),ao=document.querySelector(".modal-auth__title"),oo=document.querySelector(".modal-auth__btn-open"),so=document.querySelector(".modal-auth__close");eo.addEventListener("submit",(function(e){e.preventDefault();var t=e.target.elements.email.value,r=e.target.elements.password.value;if(console.log(t),t.length<5||r.length<6)return void alert("Please, enter your email and password (at least 6 characters)");!function(e,t,r){si(e,t,r).then((function(e){var t=e.user;t.uid;var r=t.email.split("@")[0];alert("Hello ".concat(r,", have a nice journy")),eo.reset()})).catch((function(n){var i=n.message,a="Firebase: Error (auth/email-already-in-use).";i==="Firebase: Password should be at least 6 characters (auth/weak-password)."&&alert("Password should be at least 6 characters"),a===i&&function(e,t,r){ci(e,t,r).then((function(e){var t=e.user;t.uid;var r=t.email.split("@")[0];alert("Welcome back ".concat(r,", have a nice journy")),eo.reset()})).catch((function(e){e.message==="Firebase: Error (auth/wrong-password)."&&alert("Password wrong. Please enter valid password")}))}(e,t,r)}))}($a,t,r)})),io.addEventListener("click",(function(){e=Ga(),Ce(e).signOut();var e})),oo.addEventListener("click",(function(e){e.preventDefault(),Za.classList.add("modal-open")})),so.addEventListener("click",(function(e){e.preventDefault(),Za.classList.remove("modal-open")})),Ka=function(e){console.log(e),e?(e.uid,to.classList.add("is-hidden-auth"),ro.classList.add("is-hidden-auth"),no.classList.add("is-hidden-auth"),io.classList.remove("is-hidden-auth"),ao.textContent="Hello, ".concat(e.email.split("@")[0]),oo.textContent="LogOut",oo.style.borderRight="3px solid #69ff00",console.log("удачно вошли")):(null,to.classList.remove("is-hidden-auth"),ro.classList.remove("is-hidden-auth"),no.classList.remove("is-hidden-auth"),io.classList.add("is-hidden-auth"),console.log("удачно вышли"),ao.textContent="Login form",oo.textContent="Login",oo.style.borderRight="3px solid #ff001b")},Ce($a).onAuthStateChanged(Ka,Ya,Qa);var uo={scrollBtn:document.querySelector(".scrollBtn"),rootElement:document.documentElement};window.onscroll=function(){document.body.scrollTop>2500||document.documentElement.scrollTop>2500?uo.scrollBtn.classList.add("showBtn"):uo.scrollBtn.classList.remove("showBtn")},uo.scrollBtn.addEventListener("click",(function(){uo.rootElement.scrollTo({top:0,behavior:"smooth"})}));k=a("8MBJY"),_=a("a2hTj");var co={modal:document.getElementById("myModal"),btn:document.getElementById("myBtn"),gallery:document.querySelector(".gallery"),filmModal:document.querySelector(".modal"),close:document.querySelector(".modal-film_button-close"),linkMyLibrary:document.querySelector(".js-lib_page")},lo=new R;function fo(e){co.modal.style.display="none",co.filmModal.innerHTML=""}function ho(e){return po.apply(this,arguments)}function po(){return(po=t(g)(t(b).mark((function e(r){var n,i,a,o,s,u,c,l,f,h,d;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(r.preventDefault(),r.target.closest(".movie-card__link")){e.next=4;break}return console.log("Ну туда класцнул"),e.abrupt("return");case 4:return window.addEventListener("keydown",vo),n=r.target.closest(".movie-card__link").id,e.next=8,lo.getMovieByID(n);case 8:i=e.sent,a=P(i.data),co.filmModal.insertAdjacentHTML("afterbegin",a),co.modal.style.display="block",o=document.querySelector("[data-watched]"),s=document.querySelector("[data-queue]"),document.querySelector(".modal-film_button-close").addEventListener("click",fo),u=localStorage.getItem("watched");try{c=JSON.parse(u),l=i.data.id,c.find((function(e){return e===l}))&&(o.textContent="REMOVE FROM WATCHED",o.dataset.watched="add")}catch(e){}f=localStorage.getItem("queue");try{h=JSON.parse(f),d=i.data.id,h.find((function(e){return e===d}))&&(s.textContent="REMOVE FROM QUEUE",s.dataset.queue="add")}catch(e){}o.addEventListener("click",(function(){var e=i.data.id,t=localStorage.getItem("watched");if("add"===o.dataset.watched)try{var r=JSON.parse(t),n=r.findIndex((function(t){return t===e}));r.splice(n,1);var a=JSON.stringify(r);localStorage.setItem("watched",a),o.textContent="ADD TO WATCHED",o.dataset.watched=""}catch(e){console.log("Parse error")}try{var s=t?JSON.parse(t):[];if(!s.find((function(t){return t===e}))){s.push(e);var u=JSON.stringify(s);localStorage.setItem("watched",u),o.textContent="REMOVE FROM WATCHED",o.dataset.watched="add"}}catch(e){console.log("Parse error")}})),s.addEventListener("click",(function(){var e=i.data.id,t=localStorage.getItem("queue");if("add"===s.dataset.queue)try{var r=JSON.parse(t),n=r.findIndex((function(t){return t===e}));r.splice(n,1);var a=JSON.stringify(r);localStorage.setItem("queue",a),s.textContent="ADD TO QUEUE",s.dataset.queue=""}catch(e){console.log("Parse error")}try{var o=t?JSON.parse(t):[];if(!o.find((function(t){return t===e}))){o.push(e);var u=JSON.stringify(o);localStorage.setItem("queue",u),s.textContent="REMOVE FROM QUEUE",s.dataset.queue="add"}}catch(e){console.log("Parse error")}}));case 22:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function vo(e){"Escape"===e.code&&fo()}document.addEventListener("DOMContentLoaded",(function(){co.gallery&&co.gallery.addEventListener("click",ho)})),window.onclick=function(e){e.target==co.modal&&(co.modal.style.display="none",co.filmModal.innerHTML="")},c.linkMyLibrary.addEventListener("click",(function(){c.gallery.style.display="block";c.gallery.innerHTML='<li class ="empty-my-library"><p class="title-empty-my-library">Your library is empty</p><img class="icon-empty-my-library" src="https://img.freepik.com/free-photo/rows-red-seats-theater_53876-64711.jpg" alt ="not films here"></img></li>',c.pagination.classList.add("visually-hidden");var e=localStorage.getItem("queue"),t=localStorage.getItem("watched");null!==e&&"[]"!==e&&go();null!==t&&"[]"!==t&&yo()})),c.watchedLibrary.addEventListener("click",yo),c.queueLibrary.addEventListener("click",go);var mo=new R;function go(){c.gallery.innerHTML="";var e=localStorage.getItem("queue");if(null===e||"[]"===e){c.gallery.style.display="block";c.gallery.innerHTML='<li style="text-align: center;">Your queue is empty</li>'}else try{c.gallery.style.display="grid";JSON.parse(e).map((function(e){return bo(e)}))}catch(e){c.gallery.style.display="block";c.gallery.innerHTML='<li style="text-align: center;">Failed to load library queue movies</li>'}}function yo(){c.gallery.innerHTML="";var e=localStorage.getItem("watched");if(null===e||"[]"===e){c.gallery.style.display="block";c.gallery.innerHTML='<li class ="empty-my-library"><p class = "title-empty-my-library">Your library is empty</p><img class="icon-empty-my-library" src="https://img.freepik.com/free-photo/rows-red-seats-theater_53876-64711.jpg" alt ="not films here"></img></li>'}else try{c.gallery.style.display="grid";JSON.parse(e).map((function(e){return bo(e)}))}catch(e){c.gallery.style.display="block";c.gallery.innerHTML='<li style="text-align: center;">Failed to load library watched movies</li>'}}function bo(e){return wo.apply(this,arguments)}function wo(){return(wo=t(g)(t(b).mark((function e(r){var n,i,a;return t(b).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,mo.getMovieByID(r);case 2:n=e.sent,i=L(n.data),c.gallery.insertAdjacentHTML("afterbegin",i),a=document.querySelector(".movie-card__info"),n.data.genres.length,a.textContent="".concat(n.data.genres[0].name,", ").concat(n.data.genres[1].name," | ").concat(n.data.release_date.slice(0,4));case 8:case"end":return e.stop()}}),e)})))).apply(this,arguments)}a("aNJCr").getBundleURL("EVgbq"),a("iE7OH").resolve("JQ8i3")}();
//# sourceMappingURL=index.6c1ad59d.js.map
