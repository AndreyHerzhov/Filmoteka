 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Le;Le="",ve(new M("platform-logger",(e=>new he(e)),"PRIVATE")),ve(new M("heartbeat",(e=>new Oe(e)),"PRIVATE")),Ee("@firebase/app","0.7.27",Le),Ee("@firebase/app","0.7.27","esm2017"),Ee("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
Ee("firebase","9.8.4","app");function Pe(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(n=Object.getOwnPropertySymbols(e);i<n.length;i++)t.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]])}return r}Object.create;Object.create;function Ne(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const De=Ne,Ue=new S("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),Be=new G("@firebase/auth");function Me(e,...t){Be.logLevel<=q.ERROR&&Be.error(`Auth (9.8.4): ${e}`,...t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function It(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Ot(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Tt(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(At(t))return"Blackberry";if(Ct(t))return"Webos";if(St(t))return"Safari";if((t.includes("chrome/")||kt(t))&&!t.includes("edge/"))return"Chrome";if(Rt(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=e.match(t);if(2===(null==r?void 0:r.length))return r[1]}return"Other"}function Tt(e=_()){return/firefox\//i.test(e)}function St(e=_()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function kt(e=_()){return/crios\//i.test(e)}function Ot(e=_()){return/iemobile/i.test(e)}function Rt(e=_()){return/android/i.test(e)}function At(e=_()){return/blackberry/i.test(e)}function Ct(e=_()){return/webos/i.test(e)}function Lt(e=_()){return/iphone|ipad|ipod/i.test(e)}function Pt(){return I()&&10===document.documentMode}function Nt(e=_()){return Lt(e)||Rt(e)||Ct(e)||At(e)||/windows phone/i.test(e)||Ot(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt{static parseLink(e){const t=function(e){const t=L(P(e)).link,r=t?L(P(t)).deep_link_id:null,n=L(P(e)).deep_link_id;return(n?L(P(n)).link:null)||n||r||t||e}(e);try{return new Wt(t)}catch(e){return null}}constructor(e){var t,r,n,i,s,o;const a=L(P(e)),c=null!==(t=a.apiKey)&&void 0!==t?t:null,u=null!==(r=a.oobCode)&&void 0!==r?r:null,l=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(n=a.mode)&&void 0!==n?n:null);Ve(c&&u&&l,"argument-error"),this.apiKey=c,this.operation=l,this.code=u,this.continueUrl=null!==(i=a.continueUrl)&&void 0!==i?i:null,this.languageCode=null!==(s=a.languageCode)&&void 0!==s?s:null,this.tenantId=null!==(o=a.tenantId)&&void 0!==o?o:null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Ar("rcb"),new Xe(3e4,6e4);async function Cr(e,t,r){var n;const i=await r.verify();try{let s;if(Ve("string"==typeof i,e,"argument-error"),Ve("recaptcha"===r.type,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){Ve("enroll"===t.type,e,"internal-error");const r=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Lr{verifyPhoneNumber(e,t){return Cr(this.auth,e,B(t))}static credential(e,t){return zt._fromVerification(e,t)}static credentialFromResult(e){const t=e;return Lr.credentialFromTaggedObject(t)}static credentialFromError(e){return Lr.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{phoneNumber:t,temporaryProof:r}=e;return t&&r?zt._fromTokenResponse(t,r):null}constructor(e){this.providerId=Lr.PROVIDER_ID,this.auth=Mt(e)}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Pr(e,t){return t?We(t):(Ve(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Lr.PROVIDER_ID="phone",Lr.PHONE_SIGN_IN_METHOD="phone";class Nr extends jt{_getIdTokenResponse(e){return Vt(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Vt(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Vt(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function Dr(e){return ar(e.auth,new Nr(e),e.bypassAuthState)}function Ur(e){const{auth:t,user:r}=e;return Ve(r,t,"internal-error"),or(r,new Nr(e),e.bypassAuthState)}async function Br(e){const{auth:t,user:r}=e;return Ve(r,t,"internal-error"),sr(r,new Nr(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
